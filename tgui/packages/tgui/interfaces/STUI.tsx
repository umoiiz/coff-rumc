...
/** Strip regex metacharacters that would crash .match() / break TGUI. */
function replaceRegexChars(string_to_clean: string) {
...
const RenderLog = (props: { log: string; logsfontnumber: number }) => {
