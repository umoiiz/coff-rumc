    ...
    <Window title="Pod Launcher" width={1000} height={700}>
      <Window.Content>
        ...
        <Section title="爆炸">
          ...
          <Button onClick={() => act('explosionBus')}>管理巴士</Button>
        </Section>
        <Section title="伤害">
        ...
        <Section title="移动效果">
          ...
          <Button onClick={() => act('effectTarget')}>特定目标</Button>
        </Section>
        <Section title="自定义">
        ...
        <Section title="声音">
          ...
          <Button onClick={() => act('soundVolume')}>管理员音量</Button>
        </Section>
        <Section title="延迟计时器">
