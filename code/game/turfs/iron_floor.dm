...
/turf/open/floor/iron/goonplaque
	...
	desc = "\"这是一块纪念我们G4407空间站战友的牌匾.希望TG4407型号能不负你们的声名与财富.\" 在其下方刻着一个粗糙的图案,一颗陨石和一个太空人.太空人在大笑.陨石在爆炸."
	icon_state = "plaque"
...
/turf/open/floor/iron/bluespace
	...
	desc = "遗憾的是,这些似乎并不能让你跑得更快..."

/turf/open/floor/iron/sepia
	icon_state = "sepia"
	desc = "好吧,这些地砖上的时间流速是正常的,真奇怪."

/turf/open/floor/glass
	name = "glass floor"
	desc = "别跳上去,或者跳吧,我不是你妈."
...
/turf/open/floor/glass/plasma
	...
	desc = "纳米传讯材料安全部门的研究尚未确定跳上去是否安全,风险自负."
