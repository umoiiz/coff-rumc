...
/obj/structure/sign/poster/attackby(obj/item/I, mob/user, params)
	...
	if(iswirecutter(I))
		...
		if(ruined)
			...
			to_chat(user, span_notice("你小心地从墙上取下了海报."))
...
/obj/structure/sign/poster/attack_hand(mob/living/user)
	...
	switch(tgui_alert(user, "我要把海报从墙上撕下来吗?", "你想着...", list("Yes","No")))
		if("Yes")
			if(user.loc != temp_loc)
				return
			visible_message(span_warning("[user]以果断的动作一把撕下了[src]!") )
