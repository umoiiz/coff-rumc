/obj/machinery/vending/armor_supply
	name = "\improper 剩余护甲设备售货机"
	desc = "一个自动化设备架,连接着庞大的护甲和配件储备。Nanotrasen设计了一款新售货机,利用蓝空间技术将外殖民地血汗工厂的剩余装备送到你手中!感恩吧。"
	icon_state = "surplus_armor"
	icon_vend = "surplus_armor_vend"
	icon_deny = "surplus_armor_deny"
	isshared = TRUE
	wrenchable = FALSE
	product_ads = "你制服不整,陆战队员!你的护甲呢?没有?你指望我相信这个,蛆虫?;既然可以轻装上阵超越同伴,为什么要穿重甲却追不上敌人?;等你没死的时候再感谢你的护甲吧!;我记得PAS,你记得PAS吗?;是时候画彩虹了!;这么多选择可供挑选!"
	products = list(
		"异星战士" = list(
