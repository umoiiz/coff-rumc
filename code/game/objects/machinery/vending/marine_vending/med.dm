/obj/machinery/vending/MarineMed
	name = "\improper 陆战队医疗"
	desc = "陆战队医疗药品贩卖机 - 由纳米传思制药部门(TM)提供."
	icon_state = "marinemed"
	icon_vend = "marinemed-vend"
	icon_deny = "marinemed-deny"
	product_ads = "去救几条命吧!;给你的医疗舱最好的东西.;只有最精良的工具.;全天然化学品!;这东西能救命.;你不想要点吗?"
...
/obj/machinery/vending/MarineMed/Blood
	name = "\improper MM血液贩卖机"
	desc = "陆战队医疗品牌血包贩卖机."
	icon_state = "bloodvendor"
	icon_vend = "bloodvendor-vend"
	icon_deny = "bloodvendor-deny"
	product_slogans = "市场上最好的血!;完全来自合乎道德的来源!;O型阴性是万能供血者,用它!;从今天开始预防低血容量性休克!"
	products = list(
