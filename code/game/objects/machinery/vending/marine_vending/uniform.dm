/obj/machinery/vending/uniform_supply
	...
	desc = "一个自动化的装备架,连接着一个巨大的衣物和配件储藏库.纳米传讯设计了一款新贩卖机,利用蓝空间技术将外殖民地的血汗工厂里的剩余装备送到你手中!感恩吧."
	icon_state = "surplus_clothes"
	icon_vend = "surplus_clothes_vend"
	icon_deny = "surplus_clothes_deny"
	wrenchable = FALSE
	isshared = TRUE
	product_ads = "成为你父母永远不认可的那种音乐家.;你在战场上得看起来帅气.;我们这里有各种帽子!;徒步旅行时一顶帽子对另一顶帽子说了什么?我在这儿等着,你先走;有时候,贝雷帽比头盔更好.;穿搭才是优先事项,陆战队员."
	products = list(
		"制服" = list(
