...
/obj/machinery/cic_maptable/droppod_maptable
	...
	desc = "一张显示行星地表行动区域的地图,专门用于揭示可能适合投放空降舱的区域.这对于查看前线和陆战队员的位置特别有用,这样任何投放空降舱的人都能决定在哪里着陆.祈祷你的陆地导航技能足够扎实,不会迷路!"
...
/obj/machinery/cic_maptable/yautja
	name = "hunter globe"
	desc = "一个由猎人们设计的地球仪,用于向他们显示猎场中猎物的位置."
