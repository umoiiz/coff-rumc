/obj/machinery/space_heater
	...
	icon_state = "sheater0"
	name = "space heater"
	desc = "由太空阿米什人使用传统太空技术制造,这款加热器保证不会点燃空间站。"
...
/obj/machinery/space_heater/attackby(obj/item/I, mob/user, params)
	...
	if(cell)
		balloon_alert(user, "[src]已经有一块电池了。")
		return
	...
	balloon_alert_to_viewers("[user]将一块电池插入[src]")
...
/obj/machinery/space_heater/process()
	if(!on || !cell || !cell.charge)
		balloon_alert_to_viewers("[src]关闭")
		update_icon()
		stop_processing()
		return
