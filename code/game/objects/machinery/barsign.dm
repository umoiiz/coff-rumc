/obj/machinery/barsign
	name = "bar sign"
	desc = "一个不知怎么未被初始化的酒吧招牌, 去找程序员抱怨吧!"
...
/datum/barsign/thealenath
	...
	desc = "好了,伙计。我看你已经EI NATH了。该叫辆出租车了。"
	neon_color = COLOR_RED

/datum/barsign/thenet
	name = "The Net"
	icon_state = "thenet"
	desc = "你似乎总是会沉迷其中好几个小时。"
...
/datum/barsign/thelightbulb
	...
	desc = "一家深受飞蛾和蛾类欢迎的咖啡馆。曾因酒保用樟脑丸来保护她的备用制服而停业一周。"
	neon_color = COLOR_VERY_SOFT_YELLOW
