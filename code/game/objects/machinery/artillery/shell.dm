...
/obj/item/mortal_shell/smoke
	...
	desc = "一枚80毫米迫击炮弹,装填有烟雾散布剂。可以相对安全地向陆战队员发射。比典型的80毫米炮弹要细得多。"
...
/obj/item/mortal_shell/flare
	...
	desc = "一枚80毫米迫击炮弹,装填有照明弹,比典型的80毫米炮弹要细得多。可以从更大的火炮中发射。"
...
/obj/item/mortal_shell/rocket/mlrs
	...
	desc = "一枚装填有炸药的60毫米火箭弹,用于高散布的饱和射击。"
...
/obj/item/mortal_shell/rocket/mlrs/gas
	...
	desc = "一枚装填有致命X-50气体的60毫米火箭弹,会吸取任何不幸处于其中的目标的能量和生命。"
...
/obj/item/mortal_shell/rocket/mlrs/tangle
	...
	desc = "一枚装填有缠绕足气体的60毫米火箭弹,会吸取异形的等离子体。"
	icon_state = "mlrs_rocket_gas"
...
/obj/item/mortal_shell/howitzer/he
	...
	desc = "一枚150毫米炮弹,装填有高爆炸药,被此击中的任何目标都将度过非常、非常糟糕的一天。"
	ammo_type = /datum/ammo/mortar/howi

/obj/item/mortal_shell/howitzer/plasmaloss
	name = "\improper 150毫米\"缠绕足\"炮弹"
	desc = "一枚150毫米炮弹,装填有有毒的致醉气体,被此击中的任何目标的能力都会被缓慢削弱。伴随一次小型中等爆炸。"
...
/obj/item/mortal_shell/howitzer/incendiary
	...
	desc = "一枚150毫米炮弹,装填有炸药以穿透轻型结构,然后烧毁另一侧的任何目标。将毁掉他们的一天和皮肤。"
...
/obj/item/mortal_shell/howitzer/white_phos
	...
	desc = "一枚150毫米炮弹,装填有\"标记\"气体,会点燃击中的任何目标,被此击中的任何目标的一天、皮肤和未来都将被毁掉,并会引发战争罪法庭的诉求。"
