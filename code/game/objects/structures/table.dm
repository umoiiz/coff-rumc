...
/obj/structure/table
	name = "桌子"
	desc = "一个由四条腿支撑的方形金属表面. 适合用来放东西. 紧急情况下可以翻过来作为掩体."
...
/obj/structure/table/grab_interact(obj/item/grab/grab, mob/user, base_damage = BASE_OBJ_SLAM_DAMAGE, is_sharp = FALSE)
	...
	user.visible_message(span_danger("[user]把[grabbed_mob]扔到了[src]上."),
	span_danger("你把[grabbed_mob]扔到了[src]上."))
	return TRUE
...
/obj/structure/table/wood
	name = "木桌"
	desc = "一个由四条腿支撑的方形木质表面. 适合用来放东西. 紧急情况下可以翻过来作为掩体."
...
/obj/structure/table/wood/fancy
	name = "精致木桌"
	desc = "一个由四条腿支撑的昂贵精致的木质表面. 适合用来放东西. 紧急情况下可以翻过来作为掩体."
...
/obj/structure/table/wood/rustic
	name = "乡村木桌"
	desc = "一个由四条腿支撑的乡村风格木质表面. 适合用来放东西. 紧急情况下可以翻过来作为掩体."
...
/obj/structure/table/black
	name = "黑色金属桌"
	desc = "一个由四条腿支撑的光滑黑色金属表面. 适合用来放东西. 紧急情况下可以翻过来作为掩体."
...
/obj/structure/table/wood/gambling
	name = "赌桌"
	desc = "一个由四条腿支撑的弧形木质和地毯表面. 用于赌博游戏. 紧急情况下可以翻过来作为掩体."
...
/obj/structure/table/reinforced
	name = "加固桌"
	desc = "一个由四条腿支撑的方形金属表面. 这张桌子带有侧板,使其可以作为办公桌使用,但无法翻面."
...
/obj/structure/table/reinforced/fabric
	name = "布桌"
	desc = "一张精致的布面木桌,用螺栓固定在地板上. 适合正式场合."
