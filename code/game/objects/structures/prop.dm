...
/obj/structure/prop/mainship/massdiver
	name = "质量驱动器"
	desc = "弹簧活塞玩具技术的巅峰之作,现在就在您附近的太空站上."
...
/obj/structure/prop/mainship/gateway
	name = "传送门"
	desc = "一座由未知之手建造的神秘传送门,它允许超光速旅行至遥远的地点."
...
/obj/structure/prop/mainship/holobarrier
	...
	desc = "企业补贴设计的奇迹,这种全息屏障几乎完全能抵抗大气泄漏以及近战或弹道伤害造成的损耗.它也是由太空石棉制成的,根据新的日内瓦公约属于非法物品."
	icon = 'icons/obj/structures/mainship_props.dmi'
...
/obj/structure/prop/mainship/deadai
	...
	desc = "一个标准硅基单元,被指派管理NT空间站的研究任务.这一个已完全停用."
	icon = 'icons/obj/structures/mainship_props.dmi'
	icon_state = "ai_dead"
	density = TRUE
	resistance_flags = RESIST_ALL
...
/obj/structure/prop/mainship/weapon_recharger
	name = "充电器"
	desc = "用于能量武器,PDA和其他设备的充电座.一个闪烁的小灯表明此充电器无法正常工作."
	icon = 'icons/obj/structures/mainship_props.dmi'
...
/obj/structure/prop/mainship
	name = "通用飞船道具"
	desc = "这不应该可见,如果在回合中看到请使用AHELP 'ART-P02' 并附上位置"
	density = TRUE
	coverage = 15
...
/obj/structure/prop/mainship/minigun_crate
	name = "30毫米弹药箱"
	desc = "一个装满30毫米子弹的箱子,用于运输机的一种武器吊舱.移动它需要某种升降设备."
	icon = 'icons/obj/structures/mainship_props.dmi'
...
/obj/structure/prop/mainship/mission_planning_system
	...
	desc = "任务规划系统IV(MPS IV),为UPP各处的运输机飞行员增强了任务规划和制图能力.完全能够自定义其飞行路径和装备配置以满足其作战需求."
	icon = 'icons/obj/structures/mainship_props.dmi'
	icon_state = "mps"

/obj/structure/prop/mainship/mapping_computer
	name = "\improper CMPS II计算机"
	desc = "通用制图生产系统第二版允许来自卫星和飞船系统的感官输入,以标准化方式为所有UPP飞行员推导行星地图."
	icon = 'icons/obj/structures/mainship_props.dmi'
	icon_state = "mapping_comp"

/obj/structure/prop/mainship/sensor_computer1
	name = "传感器计算机"
	desc = "IBM 10系列计算机,经过改装用作飞船的传感器计算机.虽然有些过时,但仍能发挥作用."
	icon = 'icons/obj/structures/mainship_props.dmi'
...
/obj/structure/prop/mainship/missile_tube
	name = "\improper Mk 33反卫星发射器系统"
	desc = "冷发射管,可以从中发射几种不同类型的导弹,最常见的是用于对付卫星和其他航天器的ASAAR-21\"刺剑IV\"导弹,以及用于对地攻击的BGM-227\"大锤\"导弹."
...
/obj/structure/prop/mainship/ship_memorial
	name = "胜利石板"
	desc = "一座飞船纪念碑,献给UPP的胜利和这艘飞船上阵亡的陆战队员.左侧刻有铭刻在石板上的辉煌胜利故事.右侧列出了在战斗中为UPP服役而阵亡的著名陆战队员名单."
...
/obj/structure/prop/mainship/particle_cannon
	name = "\improper 75厘米/140 马克74通用原子公司轨道炮"
	desc = "马克74轨道炮是太空武器的顶尖之作.能够以每秒24公里的速度发射直径四分之三米的炮弹.它还能使用多种弹种,凭借其新设计的供弹系统可随时更换."
	icon = 'icons/obj/machines/artillery.dmi'
	icon_state = "1"
	resistance_flags = UNACIDABLE

/obj/structure/prop/mainship/name_stencil
	name = "\improper UPP,UPP级陆战运输舰武器舰"
	desc = "船体上印有该舰船的名称."
	icon = 'icons/obj/structures/mainship_props64.dmi'
	icon_state = "UPP1"
	density = FALSE
...
/obj/structure/prop/mainship/brokengen //all the aesthetics of having a generator without any of the function
	...
	desc = "一台位于充满等离子体钻孔上方的热电发电机.电池不见了,其状态面板上滚动着奇怪的文字,你感觉它已经无法修复了."
...
/obj/structure/prop/mainship/supermatter/Bumped(atom/movable/hit_object)
	if(isliving(hit_object)) //living objects get a nifty message about heat
		hit_object.visible_message(span_danger("\The [hit_object] 撞上了 \the [src] 引发了共振... [hit_object.p_their()] 身体开始发光并燃烧起来,随后化为尘埃!"),
			span_userdanger("你撞上了 \the [src],你的耳朵里充满了诡异的鸣响.你最后的念头是 \"哦,操.\""),
			span_hear("你听到一阵诡异的噪音,一股热浪席卷了你."))
	else if(isobj(hit_object) && !iseffect(hit_object))
		hit_object.visible_message(span_danger("\The [hit_object] 猛击了 \the [src] 并迅速化为灰烬."), null,
...
/obj/structure/prop/mainship/telecomms/bus
	name = "总线主机"
	desc = "一台用于快速发送大量数据的强大硬件."
	icon = 'icons/obj/machines/telecomms.dmi'
	icon_state = "bus"

/obj/structure/prop/mainship/telecomms/broadcaster
	name = "亚空间广播器"
	desc = "这台机器呈碟形,带有绿色指示灯.它被设计用于探测和处理亚空间无线电活动."
	icon = 'icons/obj/machines/telecomms.dmi'
	icon_state = "broadcaster"

/obj/structure/prop/mainship/telecomms/receiver
	name = "亚空间接收器"
	desc = "一台碟形机器,用于广播处理过的亚空间信号."
	icon = 'icons/obj/machines/telecomms.dmi'
	icon_state = "broadcast receiver"

/obj/structure/prop/mainship/telecomms/relay
	name = "电信中继器"
	desc = "一台用于向远方发送大量数据的强大硬件."
	icon = 'icons/obj/machines/telecomms.dmi'
	icon_state = "relay"

/obj/structure/prop/mainship/suit_storage_prop
	name = "宇航服储存单元"
	desc = "一个工业级U-Stor-It储存单元,设计用于容纳各种宇航服.其搭载的设备还允许用户通过紫外线净化循环对内部物品进行消毒.控制面板上悬挂着一个警告标签,上面写着 \"严禁在单元范围内放置生物体\". 这个似乎被磁力锁定了."
	icon = 'icons/obj/structures/mainship_props.dmi'
	icon_state = "suitstorageclose"

/obj/structure/prop/mainship/protolathe
	name = "宇航服储存单元"
	desc = "一台用于处理数据和生产部门专用工具的巨型机器.一个标有\"服务器连接\"的小型警告灯正在闪烁红光"
	icon = 'icons/obj/machines/research.dmi'
	icon_state = "protolathe"
...
/obj/structure/prop/mainship/research/tdoppler
	name = "快子多普勒阵列"
	desc = "一种高精度定向传感器阵列,用于测量衰变快子释放的量子.这些量子形成的镜像所产生的多普勒频移可以揭示阵列前方大范围内能量扰动的规模,位置和时间影响.\n"
	icon_state = "tdoppler"

/obj/structure/prop/mainship/research/explosivecompressor
	name = "异常精炼机"
	desc = "一台先进的机器,能够将原始异常核心内爆压缩成成品神器.还配备了最先进的炸弹预测软件."
...
/obj/structure/prop/mainship/prop_so
	name = "军官"
	desc = "负责当前行动的参谋军官, 要么忙于操作观察控制台, 要么只是看着你和你的战友, 希望你们能成功, 话虽如此, 最好别去打扰他们."
	icon = 'icons/obj/structures/mainship_props.dmi'
...
/obj/structure/prop/mainship/prop_tech
	name = "技术员"
	desc = "一名辛勤工作的技术员, 负责维护基地的载具以及基地本身. 他们现在似乎正忙着调查什么东西."
	icon = 'icons/obj/structures/mainship_props.dmi'
...
/obj/structure/prop/mainship/prop_tech/som
	name = "SOM技术员"
	desc = "一名辛勤工作的SOM技术员, 负责维护基地的载具以及基地本身. 他们现在似乎正忙着调查什么东西."
	icon = 'icons/obj/structures/mainship_props.dmi'
...
/obj/structure/prop/mainship/prop_sominf
	name = "SOM步兵"
	desc = "标准火星之子步兵, 手持V-31突击步枪. 虽然他们的面容被面甲遮住, 但感觉你应该继续前进, 而不是在这里闲逛."
	icon = 'icons/obj/structures/mainship_props.dmi'
	icon_state = "som_inf"
	resistance_flags = RESIST_ALL
	density = TRUE
...
/obj/structure/prop/mainship/prop_sominf/heavy
	name = "SOM重装步兵"
	desc = "火星之子重装步兵, 手持VX-32充能枪. 虽然他们的面容被面甲遮住, 但感觉你应该继续前进, 而不是在这里闲逛."
...
/obj/structure/prop/mainship/som_scientist
	name = "SOM科学家"
	desc = "一名辛勤工作的SOM科学家. 他们看起来正在做什么重要的事."
	icon = 'icons/obj/structures/mainship_props.dmi'
...
/obj/structure/prop/oresilo
	name = "矿石筒仓"
	desc = "用于满足殖民地矿物分配需求的一体化蓝空间储存与传输系统. 这个似乎已停用."
...
/obj/structure/prop/mainship/meterprop/random/examine(mob/user)
	. = ..()
	. += span_notice("压力表读数为[kpa]千帕; [kelvin]开尔文 ([kelvin - 273.15]摄氏度)") //output fake kelvin and celsius on examine

/obj/structure/prop/mainship/meterprop/empty/examine(mob/user)
	. = ..()
	. += span_notice("压力表读数为0千帕; 0开尔文 (-273.15摄氏度)") //output fake kelvin and celsius on examine
...
/obj/structure/prop/mainship/halfbuilt_mech/vanguard_finished
	name = "先锋机甲"
	desc = "一台先进的先锋底盘机甲. 这是军事硬件领域的最新进展, 仅服役了很短时间, 尚未量产."
	selected_parts = list(
		MECH_GREY_TORSO = MECH_VANGUARD,
		MECH_GREY_HEAD = MECH_VANGUARD,
		MECH_GREY_LEGS = MECH_VANGUARD,
...
/obj/item/prop
	name = "通用飞船道具"
	desc = "这不应可见, 若在回合中看到请用AHELP报告'ART-P03'并附上位置"
	icon = 'icons/obj/structures/mainship_props.dmi'
	icon_state = "hangarbox"
...
/obj/structure/prop/brokenvendor/brokenuniformvendor/specialist
	...
	desc = "你徒劳地研究着这具锈迹斑斑的残骸, 试图弄清这台售货机原本是什么, 随后意识到这毫无希望."
...
/obj/structure/prop/vehicle/tank
	name = "退役TAV - 犀牛"
	desc = "一辆退役的坦克, 所有推进方式均已被禁用, 入口已被封死."
...
/obj/structure/prop/vehicle/apc
	name = "退役TAV - 雅典娜"
	desc = "一辆退役的装甲运兵车, 所有推进方式均已被禁用, 入口已被封死."
...
/obj/structure/prop/mainship/gelida/propplaceholder
	name = "占位符"
	desc = "有人搞砸了, 请在Discord上向地图创作者发送此物件的位置."
	icon = 'icons/obj/structures/mainship_props.dmi'
...
/obj/structure/prop/mainship/gelida/planterboxsoil/nondense
	density = FALSE
	name = "栈桥"
	desc = "一段你可以行走的地板. 这个带有缝隙, 可以看到下方的空间."
...
/obj/structure/prop/mainship/gelida/propserver
	name = "殖民地研究服务器"
	desc = "这台机器静静地立着, 你可以看到它的诊断面板上有一盏警示灯微弱地亮着."
	icon = 'icons/obj/machines/telecomms.dmi'
...
/obj/structure/prop/mainship/gelida/barrier
	name = "安保屏障"
	desc = "一种由安保部队用于封锁区域的可部署屏障."
	icon = 'icons/obj/structures/mainship_props.dmi'
	icon_state = "barrier0"

/obj/structure/prop/mainship/gelida/heavycablenode
	name = "重型电缆节点"
	desc = "用于在建筑之间连接高性能电缆的重型电缆节点."
	icon = 'icons/obj/structures/mainship_props.dmi'
	icon_state = "node"
	density = FALSE
...
/obj/structure/prop/vehicle/som_mech
	name = "掠夺者突击机甲"
	desc = "SOM用于带头突击的重型武装机甲,这一台似乎已经无法运作."
...
/obj/structure/prop/keycardauth
	name = "钥匙卡认证装置"
	desc = "该装置用于触发需要多于一张ID卡认证的站点功能."
	icon = 'icons/obj/monitors.dmi'
	icon_state = "auth_off"

/obj/structure/prop/turbine
	name = "动力涡轮机"
	desc = "一台靠谁知道什么东西运转的巨大涡轮机.大概懂行的人能把它启动起来."
	icon = 'icons/obj/structures/mainship_props96.dmi'
...
/obj/structure/prop/tgbrokenvendor
	...
	desc = "这台售货机的内部暴露在外且锈穿了,你感觉这台机器没救了."
	density = TRUE
...
/obj/machinery/filtration_pipes
	...
	desc = "一种专门设计用于从水中分离微生物,例如病毒和细菌的滤水器."
...
/obj/structure/prop/mainship/errorprop
	name = "错误"
	desc = "如果你在游戏中看到这个物体,你应该ahelp,有东西出问题了."
	icon = 'icons/obj/structures/mainship_props.dmi'
	icon_state = "error"

/obj/prop/mainship/prop/news_tv
	name = "TV"
	desc = "令人惊讶的是仍然相关,这台设定为新闻频道."
...
/obj/structure/prop/filtration_exit
	name = "废物排出管道"
	desc = "这台机器将净化过程中剩余的废物分离出来,以便丢弃到太空,回收为补给品,或用于研究."
...
/obj/structure/prop/golden_sclupture
	name = "金色雕塑"
	desc = "一座描绘Bravo小队三名成员的大型金色雕塑.雕刻的铭文写着'SKIBIDI LORDS 15.11'"
