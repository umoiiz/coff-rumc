...
/obj/structure/sign/securearea/firingrange
	name = "\improper 射击场"
	desc = "一块写着\"实弹射击场\"的警告标牌."
	icon_state = "firingrange"

/obj/structure/sign/biohazard
	name = "\improper 生物危害"
	desc = "一块写着\"生物危害\"的警告标牌."
	icon_state = "bio"
...
/obj/structure/sign/vacuum
	name = "\improper 前方高真空"
	desc = "一块写着\"前方高真空\"的警告标牌."
	icon_state = "space"

/obj/structure/sign/deathsposal
	name = "\improper 垃圾处理通向太空"
	desc = "一块写着\"垃圾处理通向太空\"的警告标牌."
...
/obj/structure/sign/goldenplaque
	name = "最强壮男人健壮奖"
	desc = "健壮不是一种行为或生活方式, 而是一种精神状态. 只有那些意志力足够强大, 能在危机中采取行动, 从敌人手中拯救朋友的人, 才是真正的健壮. 保持健壮, 我的朋友们."
	icon_state = "goldenplaque"

/obj/structure/sign/kiddieplaque
	name = "AI开发者牌匾"
	desc = "在极长的姓名和职位列表旁边, 有一幅小孩的画. 这个孩子似乎是残疾的. 在图像下方, 有人刻上了\"数据包\"这个词"
	icon_state = "kiddieplaque"

/obj/structure/sign/atmosplaque
	name = "\improper FEA大气部门牌匾"
	desc = "这块牌匾纪念大气FEA部门的陨落. 献给所有在其手中被烧焦, 眩晕和变得脆弱的死者."
...
/obj/structure/sign/ROsign
	name = "\improper TGMC军需办公室指南"
	desc = " 1. 你无权获得服务或装备.配件是一种特权,而非权利.\n 2. 你必须着装整齐才能获得服务.低温休眠内衣是不允许的.\n 3. 军需官拥有最终决定权和拒绝服务的权利.只有代理舰长可以推翻他的决定.\n 4. 请尊重你的军需人员.他们工作很努力."
	icon_state = "roplaque"

/obj/structure/sign/prop1
	name = "\improper TerraGov海报"
	desc = "地球政府的标志."
	icon_state = "prop1"
...
/obj/structure/sign/prop2
	...
	desc = "一张深度褪色的海报,上面是一群穿着制服、魅力四射的地球政府陆战队队员.可能是Alpha测试前拍摄的."
	icon_state = "prop2"

/obj/structure/sign/prop3
	name = "\improper TGMC海报"
	desc = "一张旧的TGMC招募海报.看着它,你心中涌起自豪与真诚的悔恨交织的情感."
	icon_state = "prop3"

/obj/structure/sign/prop4
	name = "TerraGov:为人类团结"
	desc = "一张描绘TerraGov标志和座右铭的海报,提醒陆战队员是谁在对抗异形威胁中守护着人类."
	icon_state = "prop4"
...
/obj/structure/sign/semiotic
	...
	base_icon = null
	desc = "表示符号学标准的标志.星际商业委员会要求为了你的安全,这些符号必须被放置在几乎任何地方."
	anchored = TRUE
	opacity = FALSE
	density = FALSE
	directional = FALSE
...
/obj/structure/sign/semiotic/coffee
	name = "咖啡符号"
	desc = "表示附近存在咖啡的符号标准:任何星舰船员的命脉."
	icon_state = "coffee"

/obj/structure/sign/semiotic/commline_connection
	name = "通信线路连接点符号"
	desc = "表示附近存在通信线路连接点的符号标准."
...
/obj/structure/sign/semiotic/electronics
	name = "电子系统符号"
	desc = "表示附近存在电子系统的符号标准.这是电气系统的一种花哨说法."
...
/obj/structure/sign/semiotic/waterhazard
	name = "水危险符号"
	desc = "表示水危险的符号标准. 让电子设备远离."
	icon_state = "waterhaz"

/obj/structure/sign/semiotic/west
	name = "\improper 西向符号"
	desc = "表示附近西向存在某物的符号标准."
	icon_state = "west"
