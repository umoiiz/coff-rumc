...
/obj/structure/shipmast
	...
	desc = "昔日地球的一角.铭牌上写着<br><br><span class='name'>胜利号战列舰 1765年至1922年服役.</span><br><span class='name'>2393年重新下水.</span><br><span class='name'>由第一海务大臣出借.</span><br><br>"
...
/obj/structure/cryopods
	...
	desc = "一个带有LED显示屏的大型自动胶囊,旨在让里面的任何人进入\"超睡眠\"."
	density = TRUE
	anchored = TRUE
	coverage = 15
	resistance_flags = XENO_DAMAGEABLE
...
/obj/structure/showcase/yautja
	name = "雷达控制台"
	desc = "一台配备雷达的控制台,被猎手用来探测装备和优质狩猎场."
