/obj/structure/window
	name = "窗户"
	desc = "一扇玻璃窗.它看起来很薄很脆弱.随便敲几下应该就能打碎它."
...
/obj/structure/window/attack_hand(mob/living/user)
	...
	if(user.a_intent == INTENT_HARM)
		...
		user.visible_message(span_warning("[user]撞击[src]!"),
		span_warning("你撞击[src]!"),
		span_warning("你听到撞击声."))
...
/obj/structure/window/grab_interact(obj/item/grab/grab, mob/user, base_damage = BASE_OBJ_SLAM_DAMAGE, is_sharp = FALSE)
	...
	switch(state)
		if(GRAB_PASSIVE)
			damage += base_damage
			grabbed_mob.visible_message(span_warning("[user]将[grabbed_mob]猛撞向\the [src]!"))
...
/obj/structure/window/screwdriver_act(mob/living/user, obj/item/I)
	...
	if(reinf && state >= 1)
		...
		to_chat(user, (state == 1 ? span_notice("你已经将窗户从框架上拆下.") : span_notice("你已经将窗户固定到框架上.")))
	else if(reinf && state == 0 && !static_frame)
		anchored = !anchored
		update_nearby_icons()
		playsound(loc, 'sound/items/screwdriver.ogg', 25, 1)
		to_chat(user, (anchored ? span_notice("你已经将框架固定到地板上.") : span_notice("你已经将框架从地板上拆下.")))
	else if(!reinf && !static_frame)
		anchored = !anchored
		update_nearby_icons()
		playsound(loc, 'sound/items/screwdriver.ogg', 25, 1)
		to_chat(user, (anchored ? span_notice("你已经将窗户固定到地板上.") : span_notice("你已经拆下了窗户.")))
...
/obj/structure/window/crowbar_act(mob/living/user, obj/item/I)
	...
	to_chat(user, (state ? span_notice("你已经将窗户撬入框架.") : span_notice("你已经将窗户从框架中撬出.")))
...
/obj/structure/window/phoronbasic
	name = "福龙窗户"
	desc = "一扇福龙玻璃合金窗.它看起来极其坚固,难以打破.它似乎也极其耐烧."
...
/obj/structure/window/phoronreinforced
	name = "强化福龙窗户"
	desc = "一扇带有金属杆矩阵的福龙玻璃合金窗.它看起来坚不可摧.考虑到普通福龙窗户已经极其防火,它看起来也完全防火."
...
/obj/structure/window/reinforced
	name = "强化窗户"
	desc = "一扇带有金属杆矩阵的玻璃窗.它看起来相当坚固.可能需要几下重击才能打碎它."
	icon_state = "rwindow"
	basestate = "rwindow"
	max_integrity = 40
	reinf = TRUE
...
/obj/structure/window/reinforced/toughened
	name = "安全玻璃"
	desc = "一扇看起来非常坚固的玻璃窗,带有特殊的金属杆矩阵,可能是防弹的."
	icon_state = "rwindow"
	basestate = "rwindow"
	max_integrity = 300
	reinf = TRUE
...
/obj/structure/window/reinforced/extratoughened
	name = "防护型AI玻璃"
	desc = "带有许多层金属杆矩阵的重度强化玻璃.除了最重要的窗户之外,很少用于其他用途."
	icon_state = "rwindow"
	basestate = "rwindow"
	max_integrity = 1500
	reinf = TRUE
...
/obj/structure/window/reinforced/tinted
	name = "有色窗户"
	desc = "一扇带有金属杆矩阵的玻璃窗.它看起来相当坚固且不透明.可能需要几下重击才能打碎它."
	icon_state = "twindow"
	basestate = "twindow"
	opacity = TRUE
	tinted = TRUE
...
/obj/structure/window/reinforced/tinted/frosted
	name = "磨砂窗户"
	desc = "一扇带有金属杆矩阵的玻璃窗.它看起来相当坚固且结了霜.看起来可能比普通强化窗户少挨几下就会碎."
	icon_state = "fwindow"
	basestate = "fwindow"
	max_integrity = 30
...
/obj/structure/window/shuttle
	name = "穿梭机窗户"
	desc = "一扇带有专为耐热设计的金属杆矩阵的穿梭机玻璃窗.它看起来相当坚固.可能需要几下重击才能打碎它."
...
/obj/structure/window/framed/mainship
	name = "强化窗户"
	desc = "一扇在墙壁框架内带有特殊金属杆矩阵的玻璃窗.它看起来相当坚固.可能需要几下重击才能打碎它."
...
/obj/structure/window/framed/mainship/spaceworthy
	name = "驾驶舱窗户"
	desc = "一扇看起来非常坚固的玻璃窗,带有特殊的金属杆矩阵,为太空环境而设计."
	max_integrity = 500
	icon_state = "ship_window-0"
	basestate = "ship_window"
...
/obj/structure/window/framed/mainship/hull
	name = "船体窗户"
	desc = "一扇在墙壁框架内带有特殊金属杆矩阵的玻璃窗.这一扇由特殊材料制成,以防止船体破裂.无法从这里通过."
...
/obj/structure/window/framed/mainship/requisitions
	name = "凯夫拉编织强化防弹窗户"
	desc = "一扇注入凯夫拉纤维的硼硅酸盐玻璃窗,安装在特殊的减震框架内,这将非常难以打破."
	max_integrity = 1000
	deconstructable = FALSE
...
/obj/structure/window/framed/colony/reinforced/tinted
	name = "有色强化窗户"
	desc = "一扇在墙壁框架内带有特殊金属杆矩阵的玻璃窗.它看起来相当坚固.可能需要几下重击才能打碎它.这一扇是不透明的.你有一种不安的感觉,可能有人正从另一侧看着."
	opacity = TRUE
...
/obj/structure/window/framed/chigusa
	...
	desc = "一扇玻璃窗,墙框内嵌有特殊的金属条骨架.它看起来相当坚固.可能需要几次重击才能打碎."
	max_integrity = 100
	reinf = TRUE
...
/obj/structure/window/framed/prison/reinforced/hull
	name = "船体窗户"
	desc = "一扇玻璃窗,墙框内嵌有特殊的金属条骨架.这扇装有自动百叶窗系统,以防止任何大气泄漏."
	max_integrity = 200
	//icon_state = "rwindow0_debug" //Uncomment to check hull in the map editor
	icon_state = "window-invincible"
...
/obj/structure/window/framed/prison/reinforced/nonshutter_hull
	name = "船体窗户"
	desc = "一扇玻璃窗,墙框内嵌有特殊的金属条骨架.这扇由特殊材料制成,以防止船体破损.无法从这里通过."
	damageable = FALSE
	deconstructable = FALSE
	resistance_flags = RESIST_ALL
...
/obj/structure/window/framed/prison/cell
	...
	base_icon_state = "prison_rwindow"
	basestate = "prison_rwindow"
	desc = "一扇玻璃窗,墙框内嵌有特殊的金属条骨架.没有可触及的螺丝,以防止有进取心的囚犯将其拆解."
	//icon_state = "rwindow0_debug" //Uncomment to check hull in the map editor
	deconstructable = FALSE
	max_integrity = 300
...
/obj/structure/window/framed/mainship/canterbury/dropship
	name = "轨道插入安全窗"
	desc = "一扇玻璃窗,墙框内嵌有加固的金属条骨架,强度是普通窗户的3倍,适合太空使用."
...
/obj/structure/window/framed/mainship/canterbury/dropship/reinforced
	name = "加固轨道插入安全窗"
	desc = "一扇耐用的玻璃窗,墙框内嵌有特制的加固金属条骨架,强度是普通窗户的6倍,适合太空使用并能承受冲击."
