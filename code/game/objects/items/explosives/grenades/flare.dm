...
/obj/item/explosive/grenade/flare
	name = "\improper M40 FLDP手雷"
	desc = "一种TGMC标准配发照明弹,使用标准DP罐体.可装填进任何榴弹发射器,也可用手投掷."
...
/obj/item/explosive/grenade/flare/civilian
	name = "照明弹"
	desc = "一种NT标准应急照明弹.侧面印有说明,写着'拉绳,发光'."
	icon_state = "flare"
	worn_icon_state = "flare"

/obj/item/explosive/grenade/flare/cas
	name = "\improper M50 CFDP信号照明弹"
	desc = "一种TGMC信号照明弹,采用标准DP发射器底盘.可装填至任何榴弹发射器,或用手投掷.激活后,为CAS飞行员提供目标指示."
