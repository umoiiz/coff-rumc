...
/obj/item/explosive/grenade/bullet
	...
	desc = "铅爆手雷在引爆后会释放一阵短促的弹丸爆发.请远离友军.或者别.我只是个标签."
...
/obj/item/explosive/grenade/bullet/laser
	name = "\improper M80激光爆裂手雷"
	desc = "激光爆裂手雷经过超载强化,引爆时会向四周散射一道光束.请远离友军.或者别.我只是个标签."
...
/obj/item/explosive/grenade/bullet/hefa
	name = "\improper M25 HEFA手雷"
	desc = "高爆破片手雷会造成一次威力强大但范围极小的爆炸,并伴随一圈散射的鹿弹破片,请把它扔得非常,非常,非常远."
