...
/obj/item/stack/sheet/mineral/iron
	name = "铁"
	desc = "铁是太空最基本的建筑材料,一种在室温下呈固态的金属,易于塑形且储量巨大."
...
/obj/item/stack/sheet/mineral/sandstone
	name = "砂岩砖"
	desc = "砂岩是沙子和石头的结合体. 一种原始文明的常见建筑材料, 仍然可以造出足够好的墙壁"
...
/obj/item/stack/sheet/mineral/diamond
	name = "钻石"
	desc = "钻石是碳在极端压力和高温下形成的一种特殊排列. 因其外观和特性而备受珍视, 尽管人工制造已成为可能."
...
/obj/item/stack/sheet/mineral/uranium
	name = "铀"
	desc = "铀是锕系元素中的一种放射性金属. 作为裂变型发电机的反应堆燃料, 以及作为聚变炸弹的引信而备受重视."
...
/obj/item/stack/sheet/mineral/phoron
	name = "固态phoron"
	desc = "Phoron是一种具有奇异特性的极其稀有的矿物, 常用于尖端研究. 仅仅将其制成稳定的固态形式就已经足够困难了."
...
/obj/item/stack/sheet/mineral/gold
	name = "金"
	desc = "金是一种过渡金属. 一种相对稀有的金属, 以其颜色, 光泽, 化学和电学特性而闻名, 在装饰, 工程和科学用途上都备受追捧."
...
/obj/item/stack/sheet/mineral/silver
	name = "银"
	desc = "银是一种过渡金属. 它以其同名的银灰色而闻名. 它既可作为比金更便宜的装饰替代品, 也可用于工程."
...
/obj/item/stack/sheet/mineral/platinum
	name = "铂"
	desc = "铂是一种过渡金属. 相对稀有且美观, 因其装饰价值和作为催化剂的化学特性而被使用. 它也用于电极."
...
/obj/item/stack/sheet/mineral/mhydrogen
	name = "金属氢"
	desc = "金属氢是处于近固态的普通氢, 在巨大压力下被制成锭. 制造和稳定这种锭的确切流程仍然是商业机密."
...
/obj/item/stack/sheet/mineral/tritium
	name = "氚"
	desc = "氚是氢的一种同位素, H-3, 在巨大压力下被制成锭. 制造和稳定这种锭的确切流程仍然是商业机密."
...
/obj/item/stack/sheet/mineral/osmium
	name = "锇"
	desc = "锇是一种过渡金属. 人类已知密度最大的天然存在元素, 它显然以其极高的硬度和耐久性而闻名, 并因此被使用."
