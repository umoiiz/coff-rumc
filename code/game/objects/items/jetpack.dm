...
/obj/item/jetpack_marine
	name = "陆战队喷气背包"
	desc = "一个高功率喷气背包, 燃料足以让人短距离飞行. 它能让使用者在战场上快速灵活地移动. <b>装备喷气背包时, 按住Alt右键或中键点击可飞向目的地.</b>"
...
/obj/item/jetpack_marine/heavy
	name = "重型起重喷气背包"
	desc = "一个升级版喷气背包, 燃料足以让人以极强推力短距离飞行. 它为重型使用者提供更好的机动性, 推力也足以用于进攻. <b>装备喷气背包时, 按住Alt右键或中键点击可飞向目的地. 会与敌对目标相撞</b>"
