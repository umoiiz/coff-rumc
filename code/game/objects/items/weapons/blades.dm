...
/obj/item/weapon/combat_knife
	...
	desc = "一把高品质的标准生存刀.你可以把这把刀插进靴子里,也可以用电缆线圈进行战地改装,将其固定在步枪末端."
	atom_flags = CONDUCT
...
/obj/item/weapon/combat_knife/attackby(obj/item/I, mob/user)
	...
	if(!CC.use(5))
		to_chat(user, span_notice("你没有足够的电缆."))
		return
	to_chat(user, "你在刺刀上缠了些电缆.现在它可以装在枪上了.")
	if(loc == user)
...
/obj/item/weapon/combat_knife/upp
	name = "\improper 30式生存刀"
	icon_state = "upp_knife"
	worn_icon_state = "knife"
	desc = "UPP部队的标准配发生存刀,30式实用但朴素.它小到不显累赘,但依然致命."
	force = 20
	throwforce = 10
	throw_speed = 2
	throw_range = 8
...
/obj/item/weapon/combat_knife/nkvd
	name = "\improper 芬卡NKVD"
	icon_state = "upp_knife"
	worn_icon_state = "combat_knife"
	desc = "传奇的芬卡NKVD 1934型,享有10年保修,2天内送达."
	force = 40
	throwforce = 50
	throw_speed = 2
	throw_range = 8
...
/obj/item/weapon/karambit
	...
	desc = "一把小巧的高品质弯刃刀,适合劈砍和勾拉.这把有着斑驳的红色涂层."
	atom_flags = CONDUCT
	sharp = IS_SHARP_ITEM_ACCURATE
	force = 30
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/weapon/karambit/fade
	...
	desc = "一把小巧的高品质弯刃刀,适合劈砍和勾拉.这把是用透明漆喷涂在镀铬底漆上,渐融成色的."

/obj/item/weapon/karambit/case_hardened
	icon = 'icons/obj/items/weapons.dmi'
	icon_state = "karambit_case_hardened"
	worn_icon_state = "karambit_case_hardened"
	desc = "一把小巧的高品质弯刃刀,适合劈砍和勾拉.这把是通过高温木炭进行表面硬化着色的."

/obj/item/stack/throwing_knife
	name ="\improper M11飞刀"
	icon='icons/obj/items/weapons.dmi'
	icon_state = "throwing_knife"
	desc="一种设计用于向敌人投掷的军用刀具.比枪械安静得多,但需要稳定的手才能有效使用."
	stack_name = "pile"
	singular_name = "knife"
...
/obj/item/stack/throwing_knife/proc/throw_knife()
	...
	visible_message(span_warning("[living_user]熟练地掷出了[thrown_thing]."), null, null, 5)
	update_icon()
