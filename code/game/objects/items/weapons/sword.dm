...
/obj/item/weapon/sword/mercsword
	name = "战斗剑"
	desc = "一把常见于历史博物馆的落满灰尘的剑.你从哪弄到这玩意儿的绝对是个谜.只有雇佣兵才会疯到随身携带这种东西.经过打磨,能造成巨大伤害."
...
/obj/item/weapon/sword/captain
	name = "礼仪剑"
	desc = "一把世代相传的华丽礼仪剑.尽管如此,它被保养得非常好,状态极佳."
	icon_state = "mercsword"
	worn_icon_state = "machete"
	force = 55
...
/obj/item/weapon/sword/officer/sabre
	...
	desc = "镀金,烟熏深色木柄,上面刻着你的名字,你还想要什么?"
...
/obj/item/weapon/sword/machete
	...
	desc = "TGMC砍刀的最新配发型号.非常适合在偏远殖民地的丛林或灌木丛中开路.常见于侦察兵和追踪者手中,但用常规装备很难携带."
	icon_state = "machete"
	worn_icon_state = "machete"
	attack_speed = 12
	w_class = WEIGHT_CLASS_BULKY
...
/obj/item/weapon/sword/machete/light
	name = "\improper '侦察'砍刀"
	desc = "标准TGMC砍刀的轻量紧凑型,专为便于携带和快速部署而设计.其减轻的重量和缩小的尺寸使其成为侦察兵和追踪者的青睐之选,他们优先考虑机动性,同时不牺牲在灌木丛中开路或近身战斗的实用性."
...
/obj/item/weapon/sword/machete/alt
	name = "砍刀"
	desc = "一把好看的砍刀.非常适合在偏远殖民地的丛林或灌木丛中开路.常见于侦察兵和追踪者手中,但用常规装备很难携带."
...
/obj/item/weapon/sword/katana
	name = "武士刀"
	desc = "一把制作精良的日本刀,刀刃打磨锋利.刀刃已被打磨至分子级锋利,极其致命.常见于雇佣兵和黑帮手中."
	icon_state = "katana"
	atom_flags = CONDUCT
	force = 50
	throwforce = 10
...
/obj/item/weapon/sword/katana/samurai
	name = "\improper 太刀"
	desc = "一把古代刀刃的正宗复制品.这一把状态极佳.它能对所有人造成伤害,包括你自己."
