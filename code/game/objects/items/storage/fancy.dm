...
/obj/item/storage/fancy/crayons/attackby(obj/item/I, mob/user, params)
	...
	switch(C.colourName)
		if("mime")
			to_chat(user, "这支蜡笔太悲伤了,无法被装在这个盒子里.")
		if("rainbow")
			to_chat(user, "这支蜡笔太强大了,无法被装在这个盒子里.")
...
/obj/item/storage/fancy/chemrettes
	name = "Chemrette烟盒"
	desc = "Terragov出品,化学填充香烟.现在有额外口味!"
	icon = 'icons/obj/items/cigarettes.dmi'
...
/obj/item/storage/fancy/cigarettes/dromedaryco
	name = "\improper Nanotrasen Gold烟盒"
	desc = "建设更美好的世界,卷出更好的香烟.这些高档香烟是Nanotrasen进军市场的产品.背后有强大的法律团队支持."
	icon_state = "ntpacket"
	worn_icon_state = "ntpacket"

/obj/item/storage/fancy/cigarettes/luckystars
	name = "\improper Lucky Stars烟盒"
	desc = "由合成舱培烟草制成的醇和混合烟.广告歌保证会在你脑中挥之不去."
	icon_state = "lspacket"
	worn_icon_state = "lspacket"

/obj/item/storage/fancy/cigarettes/kpack
	name = "\improper Koorlander Gold烟盒"
	desc = "Koorlander,Gold:3%烟草.97%其他.适合你想装酷,而缓慢惨死的风险不太重要的时候."
	icon_state = "kpacket"
	worn_icon_state = "kpacket"

/obj/item/storage/fancy/cigarettes/lady_finger
	name = "\improper ArctiCool Menthols烟盒"
	desc = "入门级香烟品牌,亮蓝色包装.适合你想闻起来像润喉糖又想抽烟的时候"
	icon_state = "acpacket"
	worn_icon_state = "acpacket"

/obj/item/storage/fancy/cigar
	name = "雪茄盒"
	desc = "用于在不抽雪茄时存放雪茄的盒子."
