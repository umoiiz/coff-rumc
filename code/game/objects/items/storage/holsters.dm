...
/obj/item/storage/holster/backholster/flamer
	name = "\improper TGMC喷火器背包"
	desc = "这个背包可以携带配套的喷火器, 并具有适中的通用存储容量. 会自动为其配套的喷火器补充燃料."
	icon_state = "pyro_bag"
	w_class = WEIGHT_CLASS_BULKY
...
/obj/item/storage/holster/backholster/flamer/proc/refuel(obj/item/ammo_magazine/flamer_tank/flamer_tank, mob/living/user)
	...
	to_chat(user, span_notice("[flamer_tank]已用[lowertext(tank.caliber)]重新装填."))
	update_icon()
...
/obj/item/storage/holster/blade/machete
	...
	desc = "一个用于携带M2132砍刀的大号皮革刀鞘. 可以绑在背部, 腰部或护甲上."
...
/obj/item/storage/holster/blade/harvester
	name = "H5型M2132收割者刀鞘"
	desc = "一个用于携带M2132收割者刀刃的大号皮革刀鞘. 可以绑在背部, 腰部或护甲上."
...
/obj/item/storage/holster/blade/katana
	name = "\improper 武士刀刀鞘"
	desc = "一个用于携带日本刀的大号鲜艳刀鞘. 可以绑在背部, 腰部或护甲上. 由于刀鞘坚固的木制外壳, 在紧急情况下也能作为尚可的防御武器."
...
/obj/item/storage/holster/blade/officer
	...
	desc = "一个用于携带佩剑的大号皮革剑鞘. 看起来是复制品, 而非原品. 可以绑在腰部或护甲上."
...
/obj/item/storage/holster/blade/tomahawk
	...
	desc = "一个用于携带H23战斧的大号皮革刀鞘. 可以绑在背部, 腰部或护甲上."
...
/obj/item/storage/holster/blade/tomahawk/classic
	...
	desc = "一个用于携带H17战斧的大号皮革刀鞘. 可以绑在背部, 腰部或护甲上."
...
/obj/item/storage/holster/m37
	...
	desc = "一个大号皮革枪套, 可存放任何霰弹枪. 它带有束带, 可以固定在背部以便于存放."
...
/obj/item/storage/holster/t35
	...
	desc = "一个大号皮革枪套, 可存放SH-35霰弹枪. 它带有束带, 可以固定在背部以便于存放."
...
/obj/item/storage/holster/m25
	...
	desc = "M276是TGMC的标准负重装备. 它由一条带有各种卡扣的模块化腰带组成. 此版本专为M25冲锋枪设计, 并配有更大的框架来支撑枪械. 由于其非正统的设计, 它并不常见, 仅特别配发."
...
/obj/item/storage/holster/mp19
	...
	desc = "M276是TGMC的标准负重装备. 它由一条带有各种卡扣的模块化腰带组成. 此版本专为MP-19冲锋枪设计, 并配有更大的框架来支撑枪械. 由于其非正统的设计, 它并不常见, 仅特别配发."
...
/obj/item/storage/holster/flarepouch
	name = "信号弹袋"
	desc = "一个用于存放信号弹和一把信号枪的袋子. 可用M94信号弹包重新装填."
...
/obj/item/storage/holster/icc_mg
	...
	desc = "一个背包枪套, 可存放任何ML-41突击机枪, 还能为该系统另一部分携带弹药."
...
/obj/item/storage/holster/belt/pistol/m4a3
	...
	desc = "M4A3是一种常见的手枪腰带. 它由一条带有各种卡扣的模块化腰带组成. 此版本带有枪套组合, 允许舒适安全地携带M4A3. 它还带有可存放9毫米或.45弹匣的侧袋."
...
/obj/item/storage/holster/belt/pistol/m4a3/som
	name = "\improper S19枪套挂具"
	desc = "一条起源可追溯到旧殖民地安保枪套挂具的腰带."
...
/obj/item/storage/holster/belt/pistol/m4a3/som/fancy
	name = "\improper S19-B枪套挂具"
	desc = "一条SOM军官常佩戴款式的高品质手枪腰带. 看起来老旧, 但保养良好."
...
/obj/item/storage/holster/belt/pistol/standard
	name = "\improper M276型M4A3枪套挂具"
	desc = "M276是TGMC的标准负重装备. 它由一条带有各种卡扣的模块化腰带组成. 此版本带有枪套组合, 允许舒适安全地携带M4A3. 它还带有可存放9毫米或.45弹匣的侧袋."
...
/obj/item/storage/holster/belt/revolver/t457
	name = "\improper T457型左轮手枪枪套挂具"
	desc = "T457是TGMC的标准承载装备.它由一条带有各种挂扣的模块化腰带组成."
...
/obj/item/storage/holster/belt/revolver/t500
	name = "\improper BM500型BF左轮手枪枪套挂具"
...
/obj/item/storage/holster/belt/revolver/m44
	name = "\improper M276型M44枪套挂具"
	desc = "M276是TGMC的标准承载装备.它由一条带有各种挂扣的模块化腰带组成.此版本用于M44马格南左轮手枪,并附带三个快速装弹器袋."
...
/obj/item/storage/holster/belt/revolver/mateba
	name = "\improper M276型Mateba枪套挂具"
	desc = "M276是TGMC的标准承载装备.它由一条带有各种挂扣的模块化腰带组成.此版本用于威力强大的Mateba马格南左轮手枪,并附带三个快速装弹器袋."
...
/obj/item/storage/holster/belt/pistol/korovin
	name = "\improper 41型手枪枪套挂具"
	desc = "UPP标准弹药袋挂具的改装版,用于携带一把Korovin PK-9手枪.它还包含可存放.22弹匣的侧袋,可装空尖弹或镇静剂."
...
/obj/item/storage/holster/belt/ts34
	name = "\improper M276型SH-34霰弹枪枪套挂具"
	desc = "一个专门设计的腰带枪套组件,可容纳一把SH-34霰弹枪和一个弹药盒或两把弹药."
...
/obj/item/storage/holster/belt/pistol/smart_pistol
	name = "\improper SP-13枪套挂具"
	desc = "一条枪套腰带,可容纳SP-13智能手枪及其弹匣."
...
/obj/item/storage/holster/backholster/rlsadar
	name = "TGMC RL-152背包"
	desc = "这个背包除了可携带一把SADAR发射器外,还能容纳4枚40毫米弹药."
	worn_icon_list = list(
		slot_back_str = 'icons/mob/clothing/back.dmi'
	)
...
/obj/item/storage/holster/backholster/rlquad
	name = "TGMC RL-57背包"
	desc = "这个背包除了可携带一把温压发射器外,还能容纳2组火箭弹."
	worn_icon_list = list(
		slot_back_str = 'icons/mob/clothing/back.dmi'
	)
