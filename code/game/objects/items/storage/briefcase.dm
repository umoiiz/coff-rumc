/obj/item/storage/briefcase
	name = "公文包"
	desc = "它由正宗的人造皮革制成,还挂着价格标签.它的主人一定是个真正的专业人士."
...
/obj/item/storage/briefcase/standard_magnum
	name = "R-76 Magnum枪盒"
	desc = "一个做工精良,外观昂贵的枪盒,专为容纳一把R-76 Magnum及其配件而设计.为有品位的枪主准备."
...
/obj/item/storage/briefcase/t500
	name = "\improper R-500 'Nigredo'特殊枪盒"
	desc = "由BMSS制造的高科技枪盒,用于运送他们的特殊武器.此盒上的标签写着:'这是有史以来最伟大的手枪.五发子弹.足以杀死任何会动的东西'."
	icon_state = "t500case"
...
/obj/item/storage/briefcase/t312
	name = "R-312 'Albedo'左轮手枪特殊枪盒"
	desc = "由BMSS制造的高科技枪盒,用于运送他们的特殊武器.此盒上的标签写着:'既然我们已经把Nigredo称为死亡,在同样的隐喻中我们可以把Albedo称为生命.是时候合法地向人们开枪了.'"
	icon_state = "med_case"
	w_class = WEIGHT_CLASS_NORMAL
