...
/obj/item/storage/pill_bottle/packet/bicaridine
	name = "双环己哌啶药片包"
	desc = "此药包含有双环己哌啶药片.用于治疗轻微撕裂伤.一旦取出就无法放回.一次不超过2片."
...
/obj/item/storage/pill_bottle/packet/kelotane
	name = "凯洛坦药片包"
	desc = "此药包含有凯洛坦药片.用于治疗表面烧伤.一旦取出就无法放回.一次不超过2片."
...
/obj/item/storage/pill_bottle/packet/dylovene
	name = "地洛芬药片包"
	desc = "此药包含有地洛芬药片.用于清除毒素并治疗毒素伤害.一旦取出就无法放回.一次不超过2片."
...
/obj/item/storage/pill_bottle/packet/paracetamol
	name = "对乙酰氨基酚药片包"
	desc = "此药包含有对乙酰氨基酚药片,也称为泰诺.一种长效但轻微的止痛药.一旦取出就无法放回.长时间内不超过4片."
...
/obj/item/storage/pill_bottle/packet/isotonic
	name = "等渗药片包"
	desc = "内含等渗溶液药片.用于刺激血液再生.一旦取出就无法放回."
...
/obj/item/storage/pill_bottle/packet/leporazine
	name = "来普拉嗪药片包"
	desc = "此药包含有来普拉嗪药片.能迅速稳定患者的体内温度.一旦取出就无法放回.."
...
/obj/item/storage/pill_bottle/packet/russian_red
	name = "俄罗斯红药片包"
	desc = "此药包含有俄罗斯红药片.用于在没有医护兵的情况下对危急病例进行现场治疗.一旦取出就无法放回.."
...
/obj/item/storage/pill_bottle/packet/ryetalyn
	name = "利他林药片包"
	desc = "此药包含有利他林药片.用于提供对血流毒素的防护.一旦取出就无法放回.一次不超过2片."
