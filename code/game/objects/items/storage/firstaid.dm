...
/obj/item/storage/firstaid/fire
	name = "火灾急救包"
	desc = "这是一个紧急医疗包, 用于当毒素实验室<i>-自发-</i>烧毁时使用."
...
/obj/item/storage/syringe_case/regular
	name = "基础注射器盒"
	desc = "一个用于存放注射器和药瓶的医疗盒. 这个装有基础药物."
...
/obj/item/storage/syringe_case/burn
	name = "烧伤注射器盒"
	desc = "一个用于存放注射器和药瓶的医疗盒. 这个装有用于治疗烧伤的药物."
...
/obj/item/storage/syringe_case/tox
	name = "毒素注射器盒"
	desc = "一个用于存放注射器和药瓶的医疗盒. 这个装有用于治疗毒素的药物."
...
/obj/item/storage/syringe_case/oxy
	name = "缺氧注射器盒"
	desc = "一个用于存放注射器和药瓶的医疗盒. 这个装有用于治疗缺氧的药物."
...
/obj/item/storage/pill_bottle/attackby(obj/item/I, mob/user, params)
	...
	if(paint.uses < 1)
		to_chat(user, span_warning("\the [paint]没有颜色!"))
		return
...
/obj/item/storage/pill_bottle/attack_self(mob/living/user)
	if(user.get_inactive_held_item())
		user.balloon_alert(user, "需要空出一只手")
		return
	if(length(contents))
...
/obj/item/storage/pill_bottle/kelotane
	name = "凯洛坦药瓶"
	desc = "含有治疗烧伤的药丸,但会引起轻微疼痛. 服用两颗可以加快治疗,但疼痛会略微加剧."
...
/obj/item/storage/pill_bottle/tramadol
	name = "曲马多药瓶"
	desc = "含有麻痹疼痛的药丸. 服用两颗可获得更强的效果,但代价是产生毒性效果."
...
/obj/item/storage/pill_bottle/bicaridine
	name = "比卡利定药瓶"
	desc = "含有治疗割伤和瘀伤的药丸,但会引起轻微疼痛. 服用两颗可以加快治疗,但疼痛会略微加剧."
...
/obj/item/storage/pill_bottle/russian_red
	...
	desc = "含有以少量无法治疗的伤害为代价快速治疗所有伤害的药丸."
	icon_state = "pill_canister"
...
/obj/item/reagent_containers/hypospray/autoinjector/pen/hypervene
	name = "超净素笔"
	desc = "一支装有净化剂的笔. 小心, 它会造成剧烈疼痛并净化一切."
