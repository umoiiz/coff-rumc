...
/obj/item/storage/belt/utility
	name = "\improper M276 型工具腰带挂具" //Carn: utility belt is nicer, but it bamboozles the text parsing.
	desc = "M276是TGMC的标准负重装备.它由一条带有各种卡扣的模块化腰带组成.此版本不具备任何战斗功能,通常被工程师用于运输重要工具."
	icon_state = "utilitybelt"
	worn_icon_state = "utility"
...
/obj/item/storage/belt/lifesaver
	name = "\improper M276 型救生包"
	desc = "M276是TGMC的标准负重装备.此配置挂载一个装满各种注射器和轻型医疗用品的行李袋,在医疗兵中很常见."
...
/obj/item/storage/belt/lifesaver/full/upp
	name = "\improper 41 型救生包"
	desc = "41型负重挂具是UPP军队的标准配发负重装备.此配置挂载一个装满各种注射器和轻型医疗用品的挎包,在医疗兵和游击队员中很常见."
	icon_state = "medicbag_upp"
	worn_icon_state = "medicbag_upp"

/obj/item/storage/belt/lifesaver/som
	name = "\improper S17 救生包"
	desc = "一条源自旧采矿殖民地急救员和医生所用腰带的厚重腰带."
...
/obj/item/storage/belt/lifesaver/icc
	name = "\improper Modelle/129 救生包"
	desc = "一条由合成棕褐色纤维制成的医疗腰带,几乎可以携带你在战斗中应对创伤性损伤所需的一切."
...
/obj/item/storage/belt/rig
	name = "\improper M276 型医疗存储挂具"
	desc = "M276 是 TGMC 的标准负重装备.它由一条带有各种卡扣的模块化腰带组成.此版本是一种较少见的配置,设计用于运输医疗用品和较重的医疗工具."
...
/obj/item/storage/belt/hypospraybelt
	name = "\improper M276 型注射器腰带"
	desc = "M276 是 TGMC 的标准负重装备.它由一条带有各种卡扣的模块化腰带组成.此版本是一种较少见的配置,设计用于运输注射器和试剂容器.你或许还能塞进一个注射器盒."
...
/obj/item/storage/belt/security
	name = "\improper M276 型安保挂具"
	desc = "M276 是 TGMC 的标准负重装备.它由一条带有各种卡扣的模块化腰带组成.此配置常见于 TGMC 宪兵和维和人员,不过它也能装一些轻型弹药."
...
/obj/item/storage/belt/security/tactical
	name = "战斗腰带"
	desc = "可以携带手铐和闪光弹等安保装备,带有更多小包以提供更多存储空间."
	icon_state = "swatbelt"
...
/obj/item/storage/belt/marine
	name = "\improper M276 型弹药负载挂具"
	desc = "M276 是 TGMC 的标准负重装备.它由一条带有各种卡扣的模块化腰带组成.此版本是标准型号,专为大批量弹药携带行动而设计."
...
/obj/item/storage/belt/marine/auto_catch
	name = "\improper M344 型弹药负载挂具"
	desc = "M344 是 TGMC 的现代负重装备.它由一条带有各种卡扣的模块化腰带组成.允许你在战斗行动中快速获取和使用装备."
...
/obj/item/storage/belt/marine/upp
	name = "\improper 41 型负载挂具"
	desc = "41 型负载挂具是 USL 海盗的标准配发 LBE.这条腰带的主要功能是在行动中方便取用 71 型的弹匣.尽管是为 71 型武器系统设计的,但其小包具有足够的模块化程度,可容纳其他类型的弹药和装备."
	icon_state = "upp_belt"
...
/obj/item/storage/belt/marine/som
	name = "\improper S18 弹药腰带"
	desc = "一条起源可追溯至 M276 弹药腰带和一些旧殖民地安保装备的腰带."
	icon_state = "som_belt"
...
/obj/item/storage/belt/marine/icc
	name = "\improper Modello/120 弹药腰带"
	desc = "一条专为携带弹药而制作的腰带,由棕褐色合成纤维制成."
	icon_state = "icc_belt"

/obj/item/storage/belt/marine/sectoid
	name = "\improper 奇怪的弹药腰带"
	desc = "一条由坚固但不同寻常的织物制成的腰带,带有卡扣以固定你的装备."
	icon_state = "swatbelt"
	worn_icon_state = "swatbelt"
...
/obj/item/storage/belt/shotgun
	name = "\improper 霰弹枪弹药负载挂具"
	desc = "一条设计用于容纳霰弹枪弹壳或单发子弹的弹药腰带."
...
/obj/item/storage/belt/shotgun/som
	desc = "一条设计用于容纳霰弹枪弹壳或单发子弹的弹药腰带.由传统 SOM 皮革制成."
...
/obj/item/storage/belt/shotgun/icc
	name = "\improper Modelle/121 弹药负载挂具"
	desc = "一条设计用于容纳霰弹枪弹壳或单发子弹的弹药腰带,由合成棕褐色纤维制成."
...
/obj/item/storage/belt/shotgun/martini/attackby(obj/item/I, mob/user, params)
	if(istype(I, /obj/item/ammo_magazine))
		...
		if(new_mag.caliber != CALIBER_557)
			to_chat(user, span_notice("[src]只能装填 .557/440 球形步枪弹."))
			return
	. = ..()
	update_icon()
...
/obj/item/storage/belt/knifepouch
	name = "\improper M276 型刀具挂具"
	desc = "M276 是 TGMC 的标准负重装备.它由一条带有各种卡扣的模块化腰带组成.此版本专门设计了六个刀套用于存放投掷刀.不常配发,但仍在服役中."
...
/obj/item/storage/belt/grenade
	name = "\improper M276 型 M40 HEDP 挂具"
	desc = "M276 是 TGMC 的标准负重装备.它由一条带有各种卡扣的模块化腰带组成.此版本设计用于携带大量 M40 HEDP 手榴弹."
...
/obj/item/storage/belt/grenade/som
	name = "\improper S16 型手榴弹挂具"
	desc = "一种有多种配置可供选择的简易挂具系统.此版本设计用于携带大量手榴弹."
...
/obj/item/storage/belt/grenade/b17
	name = "\improper M276 型 M40 HEDP 挂具 Mk II"
	w_class = WEIGHT_CLASS_BULKY
...
/obj/item/storage/belt/sparepouch
	name = "\improper G8 通用工具包"
	desc = "一个小巧轻便的包,可以扣在 Armat Systems M3 型装甲或你的腰带上,为杂项装备或弹箱和弹鼓提供额外存储空间."
	w_class = WEIGHT_CLASS_BULKY
...
/obj/item/storage/belt/sparepouch/som
	name = "标准工具包"
	desc = "一个小巧轻便的包,可以扣在装甲或你的腰带上,为杂项装备或弹箱和弹鼓提供额外存储空间.由真正的 SOM 皮革制成."
	icon_state = "sparepouch_som"
	worn_icon_state = "som_belt"

/obj/item/storage/belt/protein_pack
	name = "\improper 蛋白质包负载挂具"
	desc = "一条设计用于容纳大量蛋白质包的存储腰带,适合那些特别饥饿的陆战队员."
	icon_state = "p_belt"
	worn_icon_state = "shotgunbelt"
...
/obj/item/storage/belt/mortar_belt
	name = "TA-10 迫击炮腰带"
	desc = "一条可容纳一门 TA-10 50 毫米迫击炮,测距仪以及大量弹药的腰带."
