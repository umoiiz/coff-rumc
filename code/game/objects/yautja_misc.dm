/obj/structure/prop/brazier
	name = "火盆"
	desc = "火盆里的火焰发出的光芒比手电筒和照明弹相对暗淡,但没有什么能取代与朋友一起坐在壁炉旁的感觉。"
...
/obj/item/frame/torch_frame/proc/try_build(turf/on_wall)
	...
	usr.visible_message("[usr.name]将[src]附着到墙上。", \
