	...
	for(var/I in currentrun)
		...
		if(round_started && kick_inactive && !check_other_rights(C, R_ADMIN, FALSE) && C.is_afk(afk_period))
			...
			if(!isnewplayer(cmob))
				...
				to_chat(C, span_userdanger("你已因超过 [DisplayTimeText(afk_period)] 未活动而被断开连接.</span><br><span class='danger'You may reconnect via the button in the file menu or by <b><u><a href='byond://winset?command=.reconnect'>点击此处重新连接</a></b></u>"))
