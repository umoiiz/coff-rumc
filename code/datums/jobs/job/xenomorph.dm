...
/datum/job/xenomorph/radio_help_message(mob/M)
	. = ..()
	to_chat(M, "<b>你的职责是扩散蜂巢并保护蜂巢领袖.如果没有蜂巢领袖,你可以通过进化为雄蜂来自己成为伯劳或女王.</b><br>\
	使用<strong>;</strong>, <strong>.a</strong>, 或 <strong>,a</strong>在蜂巢意识中交谈(例如 ';我为女王而生!')")
...
/datum/job/xenomorph/queen/radio_help_message(mob/M)
	...
	你的职责是扩散蜂巢.</b><br>\
	使用<strong>;</strong>, <strong>.a</strong>, 或 <strong>,a</strong>在蜂巢意识中交谈(例如 ';我为蜂巢而生!')")
