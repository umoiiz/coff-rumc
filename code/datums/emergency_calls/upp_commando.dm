...
/datum/emergency_call/upp_commando/print_backstory(mob/living/carbon/human/H)
	...
	to_chat(H, "<B>你出身于[pick(25;"professionals", 25;"renegades", 50;"rogue soldiers")]的悠久血脉, 并很快加入了当地团伙以改善生活条件.</B>")
	to_chat(H, "")
	to_chat(H, "<B>今天, 你和你的队友在长期蛰伏于当地小行星带后, 被联合太空鳞翅目派往[SSmapping.configs[SHIP_MAP].map_name]. 开始渗透任务!</b>")
