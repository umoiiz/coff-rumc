...
/datum/weather/ash_storm
	name = "ash storm"
	desc = "一场强烈的大气风暴将灰烬从行星表面卷起, 并滚滚吹过整个区域, 对没有防护的人造成强烈的火焰伤害."

	telegraph_message = span_userdanger("风中响起一声诡异的哀鸣. 燃烧的灰烬遮蔽了地平线. 寻找掩护.")
	telegraph_duration = 300
	telegraph_overlay = "light_ash"

	weather_message = span_userdanger("<i>灼热的灰烬云滚滚倾泻在你周围! 快进去!</i>")
	weather_duration_lower = 600
	weather_duration_upper = 1200
	weather_overlay = "ash_storm"

	end_message = span_danger("呼啸的风吹走了最后一丝灰烬, 归于往常的低语. 现在外面应该安全了.")
	end_duration = 300
...
/datum/weather/ash_storm/emberfall
	...
	telegraph_message = span_danger("风中响起一声诡异的哀鸣. 燃烧的灰烬遮蔽了地平线.")

	weather_message = span_notice("温和的余烬像怪异的雪花一样飘落在你周围. 风暴似乎已经与你擦肩而过...")
	weather_overlay = "light_ash"

	end_message = span_notice("余烬飘落减缓, 停止. 你脚下的玄武岩又多了一层坚硬的煤烟.")
	end_sound = null
