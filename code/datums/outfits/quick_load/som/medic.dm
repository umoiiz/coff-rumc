...
/datum/outfit/quick/som/medic/standard_assaultrifle
	name = "V-31 Medic"
	desc = "让你的战友活着并继续战斗.配备一支V-31突击步枪,集成'微型榴弹'轨道发射器,中型护甲以及多种手榴弹.携带大量医疗补给,小队医护兵对于维持战斗能力至关重要.轨道发射器发射的榴弹必须在飞行途中解除保险,因此在近距离无效,但在中距离可提供重要的战术选择."
...
/datum/outfit/quick/som/medic/mpi
	name = "MPI_KM Medic"
	desc = "让你的战友活着并继续战斗.配备一支MPI_KM突击步枪,中型护甲以及多种手榴弹.携带大量医疗补给,小队医护兵对于维持战斗能力至关重要.一种在最初的火星叛乱期间常见的旧式武器,MPI良好的停止作用,可靠性以及恰到好处的怀旧感意味着尽管它已经老旧,在SOM中仍有人使用."
...
/datum/outfit/quick/som/medic/standard_carbine
	name = "V-34 Medic"
	desc = "让你的战友活着并继续战斗.配备一支V-34卡宾枪,中型护甲,拥有强大的火力和机动性,但弹药经济性和射程较差.携带大量医疗补给,小队医护兵对于维持战斗能力至关重要.V-34是一种在最初的火星叛乱期间常见的旧式武器的现代化改进型.非常可靠,在小型轻量化的包装中拥有出色的停止作用.作为VX-32的廉价得多的替代品而投入使用."
...
/datum/outfit/quick/som/medic/standard_smg
	name = "V-21 Medic"
	desc = "让你的战友活着并继续战斗.配备一支V-21冲锋枪,可变射速,在正确使用时能实现极高的射速,中型护甲以及多种手榴弹.携带大量医疗补给,小队医护兵对于维持战斗能力至关重要."
...
/datum/outfit/quick/som/medic/standard_shotgun
	name = "V-51 Medic"
	desc = "让你的战友活着并继续战斗.配备一支V-51半自动霰弹枪,中型护甲以及多种手榴弹.携带大量医疗补给,小队医护兵对于维持战斗能力至关重要."
