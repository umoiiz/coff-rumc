...
/datum/outfit/quick/som/engineer/standard_assaultrifle
	name = "V-31 Engineer"
	desc = "战场工程师; 建造与摧毁. 配备了V-31突击步枪, 带有集成\"微型榴弹\"轨道发射器, 中型装甲, 可部署的COPE哨戒炮以及多种爆炸物. 拥有各种补给和装备, 可在战场上建造, 修理或实施爆破. 对于一支全面发展的战斗部队来说, 是宝贵的支援资产. 轨道发射器发射的榴弹必须在飞行途中解除保险, 因此在近距离无效, 但在中距离增加了重要的战术选择."
...
/datum/outfit/quick/som/engineer/mpi
	...
	desc = "战场工程师; 建造与摧毁. 配备了MPI_KM突击步枪, 中型装甲, 可部署的COPE哨戒炮以及多种爆炸物. 拥有各种补给和装备, 可在战场上建造, 修理或实施爆破. 对于一支全面发展的战斗部队来说, 是宝贵的支援资产. 这是一种旧式武器, 在最初的 Martian 叛乱期间很常见, MPI良好的停止力, 可靠性以及恰到好处的怀旧感意味着尽管它已经老旧, 在SOM中仍有一些人在使用."
...
/datum/outfit/quick/som/engineer/standard_carbine
	name = "V-34 Engineer"
	desc = "战场工程师; 建造与摧毁. 配备了V-34卡宾枪, 中型装甲, 可部署的COPE哨戒炮以及多种爆炸物. 拥有各种补给和装备, 可在战场上建造, 修理或实施爆破. 对于一支全面发展的战斗部队来说, 是宝贵的支援资产. V-34是一种旧式武器的现代化改进版, 该武器在最初的 Martian 叛乱期间很常见. 非常可靠, 在小型轻量化的包装中具有出色的停止力. 作为VX-32的廉价得多的替代品投入使用."
...
/datum/outfit/quick/som/engineer/standard_smg
	name = "V-21 Engineer"
	desc = "战场工程师; 建造与摧毁. 配备了V-21冲锋枪, 其可变射速在正确使用时可实现极高的射速, 中型装甲, 可部署的COPE哨戒炮以及多种爆炸物. 拥有各种补给和装备, 可在战场上建造, 修理或实施爆破. 对于一支全面发展的战斗部队来说, 是宝贵的支援资产."
...
/datum/outfit/quick/som/engineer/standard_shotgun
	name = "V-51 Engineer"
	desc = "战场工程师; 建造与摧毁. 配备了V-51半自动霰弹枪, 中型装甲, 可部署的COPE哨戒炮以及多种爆炸物. 拥有各种补给和装备, 可在战场上建造, 修理或实施爆破. 对于一支全面发展的战斗部队来说, 是宝贵的支援资产."
