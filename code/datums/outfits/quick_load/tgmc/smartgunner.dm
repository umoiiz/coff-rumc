...
/datum/outfit/quick/tgmc/smartgunner/sg29
	...
	desc = "一把比普通熊或陆战队员更聪明的枪. 配备一把SG-29智能机枪和用'提尔'额外护甲模块升级的重型护甲, SG负责凭借你的IFF弹药提供机动, 精准的火力支援."
...
/datum/outfit/quick/tgmc/smartgunner/minigun_sg
	...
	desc = "子弹比脑子还多. 配备一把SG-85智能加特林机枪, 一把MP-19副武器, 用'提尔'额外护甲模块升级的重型护甲, 以及一大堆子弹. 适合你想要倾泻火力洪流的时候. 尽量别把弹药打光."
...
/datum/outfit/quick/tgmc/smartgunner/sg62
	...
	desc = "灵活与精准. 配备一把SG-62智能目标步枪和用'提尔'额外护甲模块升级的重型护甲. 集成的观测步枪配有多种灵活的弹药类型, 结合高伤害, 穿透力和IFF, 构成一套危险的支持装备."
