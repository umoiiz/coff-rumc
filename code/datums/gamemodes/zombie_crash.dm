...
/datum/game_mode/infestation/crash/zombie/announce()
	...
	priority_announce("登陆计划在10分钟后进行. 请做好降落准备. 初步扫描显示存在具有攻击性的生物生命形式. 你的下一个任务是获取访问代码并激活核弹头. 备选任务是摧毁所有敌对生物的生成地点.", title = "早上好, 同志们!", type = ANNOUNCEMENT_PRIORITY, sound = 'sound/AI/crash_start.ogg', color_override = "red")
