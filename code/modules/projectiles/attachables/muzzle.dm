/obj/item/attachable/suppressor
	name = "消音器"
	desc = "一个带有排气孔的小管,用于排出噪音和气体.\nDoes不能完全消除武器的声音,但能使其安静得多,并略微提高精准度和稳定性."
...
/obj/item/attachable/bayonet
	name = "刺刀"
	desc = "一种用于安装在武器上的锋利刀刃.除了在伤害意图下,它可以手动刺向任何东西.安装时会略微降低枪械的精准度."
	icon_state = "bayonet"
	worn_icon_list = list(
...
/obj/item/attachable/bayonet/screwdriver_act(mob/living/user, obj/item/I)
	to_chat(user, span_notice("你将刺刀改回了战斗刀."))
	if(loc == user)
...
/obj/item/attachable/bayonetknife //todo: why the flying dicks is this not a subtype of above?
	name = "M-22刺刀"
	desc = "一把锋利的刀,是TerraGov陆战队的标准配发战斗刀,可以随意安装在各种武器上或作为普通刀具使用."
...
/obj/item/attachable/bayonetknife/som
	...
	desc = "一把大号刀具,是SOM的标准配发战斗刀.可以随意安装在各种武器上或作为普通刀具使用."
...
/obj/item/attachable/extended_barrel
	name = "加长枪管"
	desc = "加长的枪管由于稳定性和冲击波暴露的增加,可以减少散布,提高精准度和枪口初速."
	slot = ATTACHMENT_SLOT_MUZZLE
	icon_state = "ebarrel"
...
/obj/item/attachable/heavy_barrel
	name = "枪管加速器"
	desc = "一个安装在枪口上的枪管延长器,带有小型聚能装药,能以更快的速度推动子弹.\nGreatly提高弹速并减少伤害衰减."
	slot = ATTACHMENT_SLOT_MUZZLE
	icon_state = "hbarrel"
...
/obj/item/attachable/compensator
	name = "后坐力补偿器"
	desc = "一个枪口配件,通过将排出的气体向上导引来减少后坐力和散布.\nSignificantly减少后坐力和散布,无论武器是否双手持握."
	slot = ATTACHMENT_SLOT_MUZZLE
	icon_state = "comp"
	pixel_shift_x = 17
	scatter_mod = -3
...
/obj/item/attachable/widelens
	name = "M43宽幅透镜"
	desc = "将透镜分为三个,使激光枪在过载时能使用类似传统霰弹枪射击的致命近距离爆发."
	slot = ATTACHMENT_SLOT_MUZZLE
	icon_state = "wide"
	pixel_shift_x = 18
	pixel_shift_y = 15
...
/obj/item/attachable/heatlens
	name = "M43热能透镜"
	desc = "改变激光的强度和频率.这会使你的目标着火,但代价是直接伤害和穿透力."
	slot = ATTACHMENT_SLOT_MUZZLE
	icon_state = "heat"
	pixel_shift_x = 18
	pixel_shift_y = 16
