/obj/item/attachable/flamer_nozzle
	name = "标准火焰喷射器喷嘴"
	desc = "标准火焰喷射器喷嘴。这一款喷射出一道火焰,用于直接而精准的火焰攻击。虽然不像其对应型号那样能覆盖大片区域,但这款擅长于定向的前线作战。"
...
/obj/item/attachable/flamer_nozzle/wide
	name = "喷雾火焰喷射器喷嘴"
	desc = "这款特制喷嘴以比标准喷嘴更宽广的方式喷洒所连接火焰喷射器的火焰。它用于大范围区域封锁,而非进攻性的定向火焰喷射。"
...
/obj/item/attachable/flamer_nozzle/long
	...
	desc = "这种喷嘴不是将供应的燃料散布到一片区域,而是发射单个火球来点燃远处的目标。每次射击的燃料量减少也意味着下一发准备得更快。"
