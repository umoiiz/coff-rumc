...
/obj/item/weapon/gun/smg/mp19
	...
	desc = "MP-19是TerraGov陆战队标准配发的冲锋手枪.以其低后坐力和单手使用时的散布而闻名.通常由没有空间携带更大枪支的专业部队携带,如医疗兵和工程师.使用10x20毫米无壳弹."
	icon_state = "t19"
	worn_icon_state = "t19"
...
/obj/item/weapon/gun/smg/smg90
	...
	desc = "SMG-90是TerraGov陆战队标准配发的冲锋枪.以其紧凑的尺寸和在战场上的易用性而闻名.通常由想要轻便枪械进行冲锋的部队携带.使用10x20毫米无壳弹."
...
/obj/item/weapon/gun/smg/t45
	...
	desc = "SMG-45是TerraGov陆战队使用的一款比通常更重的冲锋枪.最著名的是在小巧的包装中蕴含强大的威力.通常由想要轻便枪械进行冲锋同时打出强力一击的部队携带,但在远距离上表现不佳.使用.41 AE无壳弹."
...
/obj/item/weapon/gun/smg/m25
	...
	desc = "RivArms SMG-25冲锋枪,经典设计的升级版.一种轻型枪械,可有效单手使用,非常适合中近距离交战.使用10x20毫米弹药,配有大容量弹匣."
	icon = 'icons/obj/items/gun/submachinegun64.dmi'
	icon_state = "m25"
	worn_icon_state = "m25"
	caliber = CALIBER_10X20_CASELESS //codex
...
/obj/item/weapon/gun/smg/m25/elite
	...
	desc = "RivArms SMG-25冲锋枪的B2变体.配有集成式枪管充电器.这种可靠的武器发射穿甲10x20毫米弹药,被精锐部队使用."
	icon_state = "m25b2"
...
/obj/item/weapon/gun/smg/mp7
	...
	desc = "一种可追溯到数百年前的古老设计,SMG-27在其鼎盛时期很常见.如今它仅作为廉价的计算机打印复制品或传家宝被有限使用,不过它不知怎么落到了殖民地叛军手中."
	icon_state = "mp7"
	worn_icon_state = "mp7"
...
/obj/item/weapon/gun/smg/skorpion
	...
	desc = "一种坚固的20世纪枪械,是手枪和冲锋枪的结合体.使用20发弹匣发射.32ACP口径弹药."
	icon = 'icons/obj/items/gun/submachinegun64.dmi'
	icon_state = "skorpion"
...
/obj/item/weapon/gun/smg/ppsh
	...
	desc = "PPSh-17b或\"Papasha\"是20世纪苏联型号冲锋枪的复制品,多年来许多恐怖组织都曾仿制过.尽管其火力较弱,但其可靠性,极长的使用寿命和高射速证明对使用者很有用."
	icon = 'icons/obj/items/gun/submachinegun64.dmi'
	icon_state = "ppsh"
...
/obj/item/weapon/gun/smg/uzi
	...
	desc = "廉价,可靠的设计和制造使这种无处不在的冲锋枪尽管年代久远仍然实用.将射击选择器调到全自动以获得最大火力.如果你真想大干一场,就用两把."
	icon_state = "uzi"
	icon = 'icons/obj/items/gun/submachinegun64.dmi'
	worn_icon_state = "uzi"
...
/obj/item/weapon/gun/smg/som
	...
	desc = "V-21是火星之子使用的主要冲锋枪,设计为可有效单手或双手使用,具有可变射速.全速射击时,除非正确持握,否则其性能会严重下降,而较低射速在必要时仍可有效单手使用.它使用10x20毫米无壳弹药."
	icon_state = "v21"
	icon = 'icons/obj/items/gun/submachinegun64.dmi'
	worn_icon_state = "v21"
...
/obj/item/weapon/gun/smg/icc_machinepistol
	name = "\improper PL-38机关手枪"
	desc = "PL-38是后方ICCAF人员使用的机关手枪,在紧凑的包装中提供了在较远距离上的稳定性能,尽管因其类别而射速较慢.它使用10x20毫米无壳弹药."
	icon = 'icons/obj/items/gun/submachinegun64.dmi'
	icon_state = "pl38"
...
/obj/item/weapon/gun/smg/icc_pdw
	...
	desc = "L-40是ICCAF的主要冲锋枪,因其穿甲高速弹药而通常被称为\"PDW\",虽然它具有足够的远程性能,但主要是为近距离战斗调校的.它使用4.6毫米高速无壳弹药."
	icon = 'icons/obj/items/gun/submachinegun64.dmi'
	icon_state = "l40"
	worn_icon_state = "l40"
	worn_icon_list = list(
...
/obj/item/weapon/gun/smg/vector
	...
	desc = "Vector是TerraGov陆战队为提高陆战队员突击能力而开发的.轻便且易于使用.它采用延迟反冲系统,即使射速很高也能大幅减少后坐力.一个高度可定制的平台,可靠且多功能.快速突击的理想武器.使用加长.45 ACP空尖弹匣"
...
/obj/item/weapon/gun/smg/vsd_pdw
	...
	desc = "C17 PDW,由Crash Core制造,供民用.使用55发弹鼓发射穿甲.45 ACP,精度和射速尚可.旨在遏制监狱暴动,但它的击杀数比逮捕数还多."
	icon = 'icons/obj/items/gun/submachinegun.dmi'
	icon_state = "c17"
	worn_icon_state = "c17"
	caliber = CALIBER_45ACP //codex
