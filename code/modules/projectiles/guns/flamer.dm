...
/obj/item/weapon/gun/flamer/able_to_fire(mob/user)
	...
	if(!istype(attachments_by_slot[ATTACHMENT_SLOT_FLAMER_NOZZLE], /obj/item/attachable/flamer_nozzle))
		to_chat(user, span_warning("[src]没有安装喷嘴!"))
		return FALSE
	return TRUE
...
/obj/item/weapon/gun/flamer/big_flamer
	name = "\improper FL-240焚化器"
	desc = "FL-240已被证明是清除软目标最有效的武器之一.这是一种令人恐惧和敬畏的武器,因为它相当致命."
	icon_state = "m240"
...
/obj/item/weapon/gun/flamer/som
	...
	desc = "V-62是一种用于近距离战斗的致命武器,因其带来的恐惧和实际造成的伤害而备受青睐.作为火焰喷射器,它射程不错,但缺少其TGMC同类产品所配备的集成灭火器."
...
/obj/item/weapon/gun/flamer/big_flamer/marinestandard/engineer
	name = "\improper FL-86焚化器"
	desc = "FL-86是一款更轻便的燃烧器单元,专为装入其配套的工程师背包而设计.但只能使用弹匣式燃料罐."
	default_ammo_type = /obj/item/ammo_magazine/flamer_tank/large
	allowed_ammo_types = list(
		/obj/item/ammo_magazine/flamer_tank,
		/obj/item/ammo_magazine/flamer_tank/large,
...
/obj/item/weapon/gun/flamer/big_flamer/marinestandard
	name = "\improper FL-84火焰喷射器"
	desc = "FL-84火焰喷射器是TGMC当前的标准配发火焰喷射器,用于区域控制和城市作战.使用独特动作来使用水力炮"
	default_ammo_type = /obj/item/ammo_magazine/flamer_tank/large
	icon_state = "tl84"
