...
/obj/item/weapon/gun/pistol/p14
	...
	desc = "P-14,由地球军械库生产.一款可靠的副武器,发射9x19毫米帕拉贝鲁姆自动弹药.能够安装有限数量的配件,并能以可观的速度射击,通常是你扣扳机有多快就能射多快.使用21发9毫米弹匣."
	icon_state = "tp14"
...
/obj/item/weapon/gun/pistol/plasma_pistol
	...
	desc = "一种实验性武器,旨在将地形和目标点燃.当磁场相互缠绕时,它发出充满力量的嗡鸣声."
	icon_state = "tx7"
	worn_icon_state = "tx7"
...
/obj/item/weapon/gun/pistol/rt3
	...
	desc = "一把RT-3靶射手枪,在整个气泡区都很常见.使用9毫米弹匣."
	icon_state = "rt3"
	worn_icon_state = "rt3"
	caliber = CALIBER_9X19 //codex
	max_shells = 14 //codex
...
/obj/item/weapon/gun/pistol/p23
	...
	desc = "一把标准的P-23,口径为.45 ACP.弹匣容量较小,但威力更强.配有不可拆卸的激光瞄准器.使用.45弹匣."
	icon_state = "tp23"
...
/obj/item/weapon/gun/pistol/m1911
	...
	desc = "一把口径为.45 ACP的P-1911.一种老式武器,但其流行且极其可靠的机制为后来的许多半自动手枪提供了模板."
	icon_state = "m1911"
...
/obj/item/weapon/gun/pistol/m1911/custom
	...
	desc = "一把经过多次改装的手枪.它似乎被精心保养并代代相传.缺少自动弹匣弹出功能."
	icon_state = "m1911c"
	attachable_allowed = list(
		/obj/item/attachable/reddot,
		/obj/item/attachable/flashlight,
...
/obj/item/weapon/gun/pistol/g22/tranq
	...
	desc = "一把20世纪军用枪械,为特种部队使用而定制,发射麻醉飞镖以非致命方式击倒敌人.它似乎不接受任何其他配件."
	icon_state = "g22"
	worn_icon_state = "g22"
...
/obj/item/weapon/gun/pistol/heavy
	...
	desc = "一把口径为.50AE的马格南手枪,后坐力惊人.这把枪上刻有,<i>\"通过优势火力实现和平\"</i>."
	icon_state = "deagle"
...
/obj/item/weapon/gun/pistol/heavy/gold
	...
	desc = "一把口径为.50AE的马格南手枪,后坐力惊人.这把枪为金色表面,带有大量风格化雕刻."
	icon_state = "g_deagle"
...
/obj/item/weapon/gun/pistol/c99
	...
	desc = "一款旧式手枪设计的更新型号,具有一体式消音器,口径为极小的.22子弹.这把枪装填的是更常见的.22空尖弹,似乎是雇佣兵版本."
	icon_state = "pk9"
	worn_icon_state = "pk9"
...
/obj/item/weapon/gun/pistol/c99/tranq
	desc = "一款可追溯到20世纪的旧式东方设计的更新型号.具有一体式消音器,口径为极小的.22子弹.这把枪通常装填特殊的低后坐力.22飞镖弹,可作为危险的麻醉剂使用."
...
/obj/item/weapon/gun/pistol/holdout
	name = "藏匿手枪"
	desc = "一把微型手枪,用于藏在难以触及的地方.最好别问它从哪来的."
	icon_state = "holdout"
...
/obj/item/weapon/gun/pistol/p17
	...
	desc = "一把微型手枪,被TGMC用作应急手枪,几乎可以存放在任何地方.能塞进靴子里.使用.380 ACP,装在八发弹匣中."
	icon_state = "tp17"
...
/obj/item/weapon/gun/pistol/highpower
	...
	desc = "一把强大的半自动手枪,口径为毁灭性的.50 AE子弹.被执法部门和罪犯使用了几个世纪,最近以这种新型号重新制造."
...
/obj/item/weapon/gun/pistol/vp70
	...
	desc = "一把不常见的自动手枪,用于自卫,基于一个多世纪前的原始VP70.发射9毫米穿甲弹,能够进行三发点射或全自动射击."
	icon_state = "88m4"
...
/obj/item/weapon/gun/pistol/vp78
	...
	desc = "一把巨大而强大的自动手枪,口径为9毫米压扁弹头子弹.常见于富有的Nanotrasen成员手中."
	icon_state = "vp78"
...
/obj/item/weapon/gun/pistol/som
	...
	desc = "火星之子使用的标准副武器.一款可靠而简单的武器,常在外围殖民地的出口市场上见到.通常口径为9毫米穿甲弹."
	icon_state = "v11"
	worn_icon_state = "v11"
...
/obj/item/weapon/gun/pistol/vsd_pistol
	name = "\improper C96手枪"
	desc = "一种被殖民地保护者使用的'防暴'武器.现在被V.S.D采用,是所有成员的标准副武器.发射穿甲9x19毫米帕拉贝鲁姆弹,容量为15发."
	icon_state = "c96"
	worn_icon_state = "c96"
	caliber = CALIBER_9X19
	max_shells = 15
...
/obj/item/weapon/gun/pistol/xmdivider
	name = "\improper XM104 '分割者'左轮手枪"
	desc = "Intertech独一无二的左轮手枪.发射定制燃烧性.357子弹,具有单动和点射两种射击模式.后坐力像他妈骡子一样.你记得最高指挥部说过:'别让这东西落入敌人手中'."
...
/obj/item/weapon/gun/pistol/auto9
	...
	desc = "一种先进的选射冲锋手枪,能够进行三发点射.最后一次出现是在清理底特律的肮脏街道."
	icon_state = "auto9"
...
/obj/item/weapon/gun/pistol/icc_dpistol
	...
	desc = "PL-5是一款经过真实考验的ICCAF手枪,使用了很长时间,核心设计几乎没有变化,凭借其对于该口径而言超常的弹匣容量,最适合在近距离使用.口径为.45 ACP."
	icon_state = "pl5"
	worn_icon_state = "pl5"
	icon = 'icons/obj/items/gun/pistol64.dmi'
	caliber = CALIBER_45ACP //codex
...
/obj/item/weapon/gun/pistol/chimp
	...
	desc = "一种强大的副武器,主要配发给训练有素的精英刺客死灵赛博特工."
	icon_state = "c70"
	worn_icon_state = "c70"
	muzzleflash_iconstate = "muzzle_flash_medium"
...
/obj/item/weapon/gun/pistol/knife
	name = "\improper M6\"月蚀掠袭者\"弹道刀"
	desc = "配发给少数地球政府陆战队队员的备用求生刀.这把刀上有着多得惊人的附件挂点."
...
/obj/item/weapon/gun/pistol/smart_pistol
	...
	desc = "SP-13是地球政府陆战队使用的具备IFF能力的副武器.尖端的微型化技术使得KTLD IFF系统能够安装在手枪上,尽管制造成本高昂,且使用这种手枪通常需要专门训练.独特的设计特点是将高容量弹匣置于枪管上方,并集成瞄具."
	icon = 'icons/obj/items/gun/pistol64.dmi'
	icon_state = "sp13"
