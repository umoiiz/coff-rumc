...
/obj/item/weapon/gun/revolver/examine(mob/user)
	...
	if(!(reciever_flags & AMMO_RECIEVER_ROTATES_CHAMBER))
		return
	. += span_notice("它的弹巢可以用<b>alt-right-click</b>旋转.")
...
/obj/item/weapon/gun/revolver/proc/do_spin(mob/user)
	...
	visible_message(span_notice("[user]旋转[src]的弹巢."), span_notice("你旋转[src]的弹巢."))
...
/obj/item/weapon/gun/revolver/r44
	...
	desc = "R-44标准战斗左轮手枪,由Terran Armories生产.一把坚固且威力强大的火器,装填.44马格南弹.弹巢可容纳7发子弹.由于弹巢旋转系统的错误,该枪的射速远超预期,最终被宣传为该系统的一项特色."
	icon_state = "tp44"
...
/obj/item/weapon/gun/revolver/upp
	...
	desc = "Nagant-Yamasaki 7.62是一台由一群可疑的非美国人组成的财团设计的有效杀戮机器.经常出现在罪犯或雇佣兵手中."
	icon_state = "ny762"
...
/obj/item/weapon/gun/revolver/small
	name = "\improper FFA 'Rebota'左轮手枪"
	desc = "一把由Falffearmeria制造的轻巧.357.一个永恒的设计,从古代到未来.这把枪以其奇怪的弹药而闻名,子弹会不断从墙壁上弹射.这从缺陷变成了一项特色."
	icon_state = "rebota"
...
/obj/item/weapon/gun/revolver/mateba
	...
	desc = "R-24是TGMC使用的相当稀有的自动左轮手枪,以相当少的数量配发给后方人员和军官,它利用后坐力来旋转弹巢.使用重型.454弹药."
	icon_state = "mateba"
...
/obj/item/weapon/gun/revolver/cmb
	...
	desc = "一把装填.357马格南的自动左轮手枪.通常配发给Nanotrasen安保人员.它具有点射模式.目前正在与Terra及其他殖民地各地的其他左轮手枪一起进行试验."
	icon_state = "cmb"
	worn_icon_state = "cmb"
	caliber = CALIBER_357 //codex
	max_chamber_items = 6 //codex
...
/obj/item/weapon/gun/revolver/judge
	name = "\improper 'Judge'左轮手枪"
	desc = "一把极其罕见的左轮手枪,利用超大弹巢既能发射45 Long,代价是射速.普通弹药没有伤害衰减,几乎没有散布.由于枪管短,发射鹿弹时散布很大."
	icon_state = "judge"
...
/obj/item/weapon/gun/revolver/standard_magnum
	...
	desc = "R-76马格南是TGMC使用的一把绝对的野兽级手枪,有传言说它是某位将军因这把火器完全不实用而搞出的洗钱计划.威力强大,建议配合其枪托配件使用.装填12.7mm弹药."
...
/obj/item/weapon/gun/revolver/standard_magnum/fancy/gold
	desc = "一把镀金的R-76马格南,确保它既极其昂贵又极其不实用.R-76马格南是TGMC使用的一把绝对的野兽级手枪,有传言说它是某位将军因这把火器完全不实用而搞出的洗钱计划.威力强大,建议配合其枪托配件使用.装填12.7mm弹药."
	icon_state = "g_t76"
	worn_icon_state = "g_t76"
	fire_animation = "g_t76_fire"

/obj/item/weapon/gun/revolver/standard_magnum/fancy/silver
	desc = "一把镀银的R-76马格南,确保它既极其昂贵又极其不实用.R-76马格南是TGMC使用的一把绝对的野兽级手枪,有传言说它是某位将军因这把火器完全不实用而搞出的洗钱计划.威力强大,建议配合其枪托配件使用.装填12.7mm弹药."
	icon_state = "s_t76"
	worn_icon_state = "s_t76"
	fire_animation = "s_t76_fire"

/obj/item/weapon/gun/revolver/standard_magnum/fancy/nickle
	desc = "一把镀镍的R-76马格南,外观更为雅致.R-76马格南是TGMC使用的一把绝对的野兽级手枪,有传言说它是某位将军因这把火器完全不实用而搞出的洗钱计划.威力强大,建议配合其枪托配件使用.装填12.7mm弹药."
	icon_state = "n_t76"
...
/obj/item/weapon/gun/revolver/single_action/m44
	...
	desc = "一把不常见的左轮手枪,偶尔由民用执法部门携带,非常明显是基于现代化单动式陆军左轮手枪.每次射击都必须手动扳动击锤.使用.44马格南弹药."
	icon_state = "m44"
	worn_icon_state = "m44"
	caliber = CALIBER_44 //codex
	max_chamber_items = 6
...
/obj/item/weapon/gun/revolver/coltrifle
	...
	desc = "一种左轮手枪与卡宾枪的混合体,由Crowford Armory Union在很久以前设计并制造.当时很受欢迎,但如今已完全过时.仍被一些古董爱好者使用."
...
/obj/item/weapon/gun/revolver/t500
	...
	desc = "R-500 'Nigredo'左轮手枪,装填.500 Nigro Express弹药.难以使用,但威力如同它震痛你手一样猛烈.这把由BMSS制造的手枪,被设计为一种致命,邪恶的力量,能阻止一切移动的东西,作为交换,这把左轮手枪缺乏后坐力控制,并且拥有紧密的扳动系统.由于其特定的手炮定位,仅生产了少量.黑与梅策尔特殊配件系统可以将这把极其强大的手枪变成全尺寸步枪,使其成为超越合金装备的武器."
	icon = 'icons/obj/items/gun/pistol64.dmi'
	icon_state = "t500"
	worn_icon_list = list(
		slot_l_hand_str = 'icons/mob/inhands/gun/pistol_lefthand_1.dmi',
...
/obj/item/weapon/gun/revolver/t312
	...
	desc = "未来风格的轨道炮系统左轮手枪,用于发射EMB(实验性医疗子弹).只需先确保你装填的是EMB,而不是.500 White Express."
	icon = 'icons/obj/items/gun/pistol64.dmi'
	icon_state = "t312"
