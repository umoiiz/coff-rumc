...
/obj/item/weapon/gun/rifle/sniper/antimaterial
	...
	desc = "SR-26是一种具备IFF能力的狙击步枪,主要由远程射手使用.它在远程战斗情境和支援狙击方面表现出色.它安装了激光指示器,瞄准镜本身也集成了IFF.使用专门制造的10x28无壳弹药,以配合该枪奇特的IFF瞄准镜系统.\nIt配有集成式目标标记器和激光瞄准系统.\n\"以优势火力促和平\"."
...
/obj/item/weapon/gun/rifle/sniper/antimaterial/proc/laser_off(mob/user)
	...
	if(user?.client)
		...
		to_chat(user, span_notice("<b>你停用目标标记器.</b>"))
		playsound(user,'sound/machines/click.ogg', 25, 1)
	return TRUE
...
/obj/item/weapon/gun/rifle/sniper/elite
	...
	desc = "来自Nanotrasen的高端磁轨重型狙击步枪,使用可用的最重型弹药,10x99毫米无壳弹."
	icon_state = "m42c"
...
/obj/item/weapon/gun/rifle/sniper/svd
	...
	desc = "一种半自动狙击步枪,以其精准射击而闻名,并且是为此从头打造的.发射7.62x54毫米R弹药."
	icon = 'icons/obj/items/gun/marksman64.dmi'
	worn_icon_list = list(
...
/obj/item/weapon/gun/rifle/tx8
	...
	desc ="BR-8是一种轻型专用侦察步枪,主要由轻步兵和侦察兵使用.由于能够使用不同弹药类型,它对不同情况具有极强的适应性,因此设计为可在所有距离使用.具备IFF.使用专用超压10x28毫米弹药."
	icon = 'icons/obj/items/gun/marksman64.dmi'
	icon_state = "tx8"
	worn_icon_state = "tx8"
	worn_icon_list = list(
...
/obj/item/weapon/gun/minigun
	name = "\improper MG-100辩护者转轮机枪"
	desc = "一种六管旋转机枪,单兵便携火力的终极体现.能够持续倾泻高速穿甲弹.尽量不要用它杀光你所有的朋友."
...
/obj/item/weapon/gun/minigun/one_handed
	name = "\improper 改装MG-100辩护者转轮机枪"
	desc = "一种经过改装可单手使用的转轮机枪.设计用于安装在载具上."
...
/obj/item/weapon/gun/rifle/pepperball
	...
	desc = "PB-12表面上是TGMC使用的防暴控制装置,颜色很漂亮,通过SAN球释放短效中和化学物质来击倒目标或削弱他们.保证对几乎所有东西都有效.使用SAN球容器作为弹匣."
...
/obj/item/weapon/gun/rifle/pepperball/pepperball_mini
	name = "迷你胡椒球枪"
	desc = "PB-12胡椒球枪的可附加版本.弹匣容量更小,射速更慢."
...
/obj/item/weapon/gun/launcher/rocket
	...
	desc = "RL-5是银河系周围主要的反装甲武器.用于摧毁轻型坦克和敌方建筑,RL-5火箭发射器是一种具有多种战斗用途的危险武器.使用多种84毫米火箭弹."
	icon_state = "m5"
	worn_icon_state = "m5"
	max_shells = 1 //codex
...
/obj/item/weapon/gun/launcher/rocket/sadar
	...
	desc = "RL-152是TGMC的主要反装甲武器.用于摧毁轻型坦克和敌方建筑,RL-152火箭发射器是一种具有多种战斗用途的危险武器.使用多种84毫米火箭弹."
	icon = 'icons/obj/items/gun/special64.dmi'
	icon_state = "sadar"
...
/obj/item/weapon/gun/launcher/rocket/m57a4
	...
	desc = "RL-57A可能是史上最具破坏性的单兵便携武器.它是一种4管导弹发射器,能够连发4枚温压导弹.无需多言."
	icon_state = "m57a4"
...
/obj/item/weapon/gun/launcher/rocket/m57a4/t57
	...
	desc = "RL-57可能是最糟糕的单兵便携武器.它是一种4管导弹发射器,能够连发4枚温压导弹,火箭几乎没有推力.无需多言."
	icon_state = "t57"
	worn_icon_state = "t57"
...
/obj/item/weapon/gun/launcher/rocket/recoillessrifle
	...
	desc = "RL-160无后坐力步枪是TGMC使用的远程爆炸性弹药装置,用于向远距离发射爆炸性炮弹.使用多种为不同目的设计的67毫米炮弹."
	icon = 'icons/obj/items/gun/special64.dmi'
	icon_state = "t160"
...
/obj/item/weapon/gun/launcher/rocket/oneuse
	...
	desc = "这是整个银河系广泛使用的首要一次性火箭发射器,无法在战场上重新装填或卸载.这一把发射84毫米爆炸火箭.按空格键可缩短或展开它,分别用于储存或发射."
	icon = 'icons/obj/items/gun/special64.dmi'
	icon_state = "t72"
	worn_icon_state = "t72"
	max_shells = 1 //codex
...
/obj/item/weapon/gun/launcher/rocket/som
	...
	desc = "V-71是SOM使用的单兵便携火箭推进榴弹发射器.其设计几个世纪以来几乎没有变化,重量轻且制造成本低,同时能够发射多种84毫米火箭弹,提供出色的战术灵活性."
	icon = 'icons/obj/items/gun/special64.dmi'
	icon_state = "rpg"
	worn_icon_state = "rpg"
	gun_features_flags = GUN_WIELDED_FIRING_ONLY|GUN_WIELDED_STABLE_FIRING_ONLY|GUN_AMMO_COUNTER|GUN_SHOWS_LOADED|GUN_SMOKE_PARTICLES
...
/obj/item/weapon/gun/launcher/rocket/icc
	...
	desc = "单兵便携式步兵火箭发射器是ICC使用的一种单兵便携式弹头发射器. 能够发射多种83毫米后装火箭弹, 在紧凑的包装中提供出色的战术灵活性."
	icon = 'icons/obj/items/gun/special64.dmi'
	icon_state = "iccrpg"
...
/obj/item/weapon/gun/launcher/rocket/vsd
	name = "\improper C153肩扛式发射器"
	desc = "由Crash Core制造的一种反人员火箭发射器. 主要由V.S.D专家使用, 可发射三种专用弹药. 高爆弹, 燃烧高爆弹和化学覆盖高爆弹."
	icon = 'icons/obj/items/gun/special64.dmi'
	icon_state = "c153"
...
/obj/item/weapon/gun/rifle/railgun
	...
	desc = "RG-220是一种专用的重型轨道炮, 旨在击穿硬质装甲以便进行后续攻击. 使用专用罐体装填."
	icon = 'icons/obj/items/gun/special64.dmi'
	icon_state = "railgun"
...
/obj/item/weapon/gun/rifle/icc_coilgun
	...
	desc = "ML-120线圈炮是ICCAF中最常见的线圈炮, 以极高速度发射磁性弹丸. 它需要一些蓄力时间, 但会穿透墙壁, 你的敌人, 还有你的友军. 所以小心... 使用专用罐体装填."
	icon = 'icons/obj/items/gun/special64.dmi'
	icon_state = "ml120"
