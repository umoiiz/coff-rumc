...
/obj/item/weapon/gun/shotgun/combat
	...
	desc = "Nanotrasen SH-221霰弹枪,一种基于数百年历史的Benelli M4霰弹枪设计的快速射击半自动霰弹枪.仅以少量配发给TGMC."
...
/obj/item/weapon/gun/shotgun/combat/standardmarine
	...
	desc = "Terran Armories SH-39战斗霰弹枪是TGMC小队中破门手和尖兵使用的半自动霰弹枪.使用12号口径弹药."
...
/obj/item/weapon/gun/shotgun/combat/masterkey
	name = "主钥匙霰弹枪"
	desc = "一种安装在武器上的三发霰弹枪.可使用任何普通12号口径弹药重新装填.短枪管大幅降低了弹药效能,以换取作为配件安装的能力."
...
/obj/item/weapon/gun/shotgun/double
	name = "双管霰弹枪"
	desc = "一种上下排列的双管霰弹枪,设计古老但坚固.使用12号口径弹药,但一次只能装填2发."
	equip_slot_flags = ITEM_SLOT_BACK
	icon_state = "dshotgun"
...
/obj/item/weapon/gun/shotgun/double/sawn
	name = "截短霰弹枪"
	desc = "一种双管霰弹枪,其枪管被人工缩短以减小射程,从而获得更强的近距离作战潜力."
	icon_state = "sshotgun"
...
/obj/item/weapon/gun/shotgun/double/marine
	...
	desc = "TGMC使用的一种设计古老但坚固的双管霰弹枪.由于有枪管爆裂的报告,同时发射两根枪管的能力已被禁用.使用12号口径弹药,但一次只能装填2发."
	equip_slot_flags = ITEM_SLOT_BACK
	icon_state = "ts34"
...
/obj/item/weapon/gun/shotgun/pump
	...
	desc = "经典设计,使用过时的霰弹枪框架.V10将近距离火力与长期可靠性结合在一起.\n<b>需要泵动,即独特动作键.</b>"
	equip_slot_flags = ITEM_SLOT_BACK
	icon_state = "v10"
	worn_icon_state = "v10"
	default_ammo_type = /datum/ammo/bullet/shotgun/buckshot
...
/obj/item/weapon/gun/shotgun/pump/cmb
	...
	desc = "一种九发泵动霰弹枪.一种用于狩猎、家庭防卫和警务工作的霰弹枪,存在许多版本,几乎任何人都在使用."
	icon = 'icons/obj/items/gun/shotgun64.dmi'
	icon_state = "pal12"
...
/obj/item/weapon/gun/shotgun/pump/trenchgun
	...
	desc = "一种六发泵动霰弹枪.一种用于狩猎、家庭防卫和警务工作的霰弹枪,存在许多版本,几乎任何人都在使用."
	icon = 'icons/obj/items/gun/shotgun64.dmi'
...
/obj/item/weapon/gun/shotgun/pump/icc_heavyshotgun
	...
	desc = "奇怪地在霰弹枪上使用了膛线枪管.ML-101霰弹枪被ICC人员部队用于在近距离摧毁目标.使用6号口径弹药.\n<b>需要泵动,即独特动作键.</b>"
	equip_slot_flags = ITEM_SLOT_BACK
	icon = 'icons/obj/items/gun/shotgun64.dmi'
	icon_state = "ks23"
...
/obj/item/weapon/gun/shotgun/pump/bolt
	...
	desc = "一把莫辛-纳甘步枪,光是看着它你就能感受到防锈油的存在.常被愚蠢的殖民者和不法之徒以其俚语\"湿润金块\"而闻名."
...
/obj/item/weapon/gun/shotgun/double/martini
	...
	desc = "一种杠杆式步枪,可装填一发.557/440球形弹.非常适合任何类型的狩猎,无论是大象还是异形,因为它出枪极快."
	equip_slot_flags = ITEM_SLOT_BACK
	icon = 'icons/obj/items/gun/marksman64.dmi'
	icon_state = "martini"
...
/obj/item/weapon/gun/shotgun/double/derringer
	...
	desc = "R-2395德林杰手枪数百年来一直是经典之作.这一最新迭代将等离子推进火药与经典设计相结合,打造出一种几乎不留任何机会的暗杀武器."
...
/obj/item/weapon/gun/shotgun/pump/lever
	name = "杠杆步枪"
	desc = "一种.44马格南杠杆步枪,带有侧装填口.射速较低,但在狩猎中威力十足."
...
/obj/item/weapon/gun/shotgun/pump/lever/repeater
	...
	desc = "据说就是这把枪赢得了西部.但太空是一种完全不同的边疆,使用.45-70 Government口径."
	icon = 'icons/obj/items/gun/marksman64.dmi'
...
/obj/item/weapon/gun/shotgun/pump/lever/mbx900
	...
	desc = "一把.410口径杠杆式霰弹枪,射速几乎与你操作杠杆的速度一样快.因其毁灭性且极其可靠的设计而闻名."
	icon_state = "mbx900"
...
/obj/item/weapon/gun/shotgun/pump/t35
	...
	desc = "地球军械库的SH-35是地球政府陆战队使用的霰弹枪.当有人想要比大多数人更适用于近距离的武器时,它被用作近战工具,或者作为背上的应急副武器.使用12号霰弹.\n<b>需要泵动,即独特动作键.</b>"
	equip_slot_flags = ITEM_SLOT_BACK
	icon = 'icons/obj/items/gun/shotgun64.dmi'
	icon_state = "t35"
	worn_icon_state = "t35"
...
/obj/item/weapon/gun/shotgun/zx76
	...
	desc = "ZX-76突击霰弹枪,一把极其罕见的双管半自动战斗霰弹枪,具有双发模式.可能是无与伦比的近战之王.拥有9发内置弹匣."
	icon = 'icons/obj/items/gun/shotgun64.dmi'
	icon_state = "zx-76"
...
/obj/item/weapon/gun/shotgun/som
	...
	desc = "V-51是火星之子使用的主要霰弹枪.射速比其他一些半自动霰弹枪慢,但威力更大."
	equip_slot_flags = ITEM_SLOT_BACK
	icon_state = "v51"
	icon = 'icons/obj/items/gun/shotgun64.dmi'
	worn_icon_state = "v51"
...
/obj/item/weapon/gun/shotgun/som/burst
	...
	desc = "V-51B定制版.标准SOM霰弹枪的升级版本,具有点射模式和一流的涂装.稀有而致命."
	icon_state = "v51b"
	burst_amount = 2
...
/obj/item/weapon/gun/shotgun/micro_grenade
	...
	desc = "一种内置轨道炮,设计用于发射所谓的'微型榴弹'.通过使用轨道炮技术,弹丸不需要任何推进剂,极大地增加了有效载荷的可用空间."
	icon = 'icons/obj/items/attachments/attachments.dmi'
	icon_state = "va61"
...
/obj/item/weapon/gun/shotgun/combat/shq6
	...
	desc = "SH-46,是一款半自动,12号口径,气动活塞式霰弹枪,由CAU为TGMC发布."
	force = 20 //Has a stock already
	equip_slot_flags = ITEM_SLOT_BACK
	icon = 'icons/obj/items/gun/shotgun64.dmi'
	icon_state = "shq6"
...
/obj/item/weapon/gun/shotgun/pump/ksg
	...
	desc = "一把十四发泵动霰弹枪.令人叹为观止.发射12号霰弹,其十四发的容量使它在清理房间时非常顺畅.侧面标签写着:'仅限近战!!'."
	icon = 'icons/obj/items/gun/shotgun64.dmi'
	icon_state = "l12"
	worn_icon_state = "l12"
