...
/obj/item/weapon/gun/sentry/basic
	...
	desc = "可部署的自动炮塔,内置AI.没有任何改装.进行高效而精准的射击."
	icon_state = "sentry"
...
/obj/item/weapon/gun/energy/lasgun/lasrifle/volkite/cope
	...
	desc = "百夫长全向点防御能量哨戒炮是SOM使用的一种单兵便携式自动武器系统.它在手中激活后投掷到位,然后展开,其贴地外形使其成为一个难以准确命中的目标.配备紧凑型沃尔凯特武器系统和可充电电池以支持长时间使用,但在紧急情况下也可以使用普通沃尔凯特电池."
	icon_state = "cope"
	icon = 'icons/obj/sentry.dmi'
	max_integrity = 225
...
/obj/item/weapon/gun/sentry/mini
	...
	desc = "可部署的自动炮塔,内置AI.安装了缩小尺寸和口径的改装型号,极其易于部署."
...
/obj/item/weapon/gun/sentry/premade
	name = "SG-577高斯炮塔"
	desc = "一种可部署的半自动炮塔,具有AI瞄准能力.配备一门穿甲MIC高斯炮和大容量弹鼓."
	icon_state = "sentry"
...
/obj/item/weapon/gun/sentry/premade/dumb
	...
	desc = "一种可部署的半自动炮塔,具有AI瞄准能力.配备一门M30机炮和500发弹鼓.这台机器的IFF系统已被禁用,它会向射程内的任何目标开火."
	gun_features_flags = GUN_AMMO_COUNTER|GUN_DEPLOYED_FIRE_ONLY|GUN_WIELDED_FIRING_ONLY|GUN_SMOKE_PARTICLES
...
/obj/item/weapon/gun/sentry/sniper
	...
	desc = "可部署的自动炮塔,内置AI.安装了用于远距离大口径射击的改装型号."
...
/obj/item/weapon/gun/sentry/shotgun
	...
	desc = "可部署的自动炮塔,内置AI.安装了用于近距离大规模火力输出的改装型号."
...
/obj/item/weapon/gun/sentry/flamer
	...
	desc = "可部署的自动炮塔,内置AI.安装了用于发射燃烧燃料团的改装型号."
