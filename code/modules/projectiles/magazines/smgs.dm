...
/obj/item/ammo_magazine/smg/mp19
	name = "\improper MP-19机关手枪弹匣 (10x20mm)"
	desc = "一个10x20mm无壳机关手枪弹匣."
	caliber = CALIBER_10X20_CASELESS
	icon_state = "t19"
	icon_state_mini = "mag_smg"
	max_rounds = 45
...
/obj/item/ammo_magazine/smg/t45/squashhead
	name = "\improper SMG-45碎甲弹匣 (.41 AE)"
	desc = "一个.41 AE无壳冲锋枪弹匣,接触时会产生微型爆炸."
...
/obj/item/ammo_magazine/smg/som/rad
	...
	desc = "一个10x20mm无壳冲锋枪弹匣,装填有放射性弹药. 小心处理."
	icon_state = "v21_rad"
...
/obj/item/ammo_magazine/smg/icc_machinepistol
	name = "\improper PL-38穿甲机关手枪弹匣 (10x20mm)"
	desc = "一个10x20mm无壳穿甲机关手枪弹匣."
	caliber = CALIBER_10X20_CASELESS
	icon_state = "pl38"
	icon_state_mini = "mag_smg_dark"
	default_ammo = /datum/ammo/bullet/smg/ap
...
/obj/item/ammo_magazine/smg/icc_machinepistol/hp
	name = "\improper PL-38空尖机关手枪弹匣 (10x20mm)"
	desc = "一个10x20mm无壳空尖机关手枪弹匣."
...
/obj/item/ammo_magazine/smg/vector
	...
	desc = "一个用于Vector的.45ACP弹鼓,拥有更强的火力."
...
/obj/item/ammo_magazine/smg/vector/incendiary
	...
	desc = "一个用于Vector的.45ACP燃烧弹鼓,拥有更强的火力."
	ammo_band_color = AMMO_BAND_COLOR_INCENDIARY
