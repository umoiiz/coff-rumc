...
/obj/item/ammo_magazine/flamer_tank
	name = "焚化器燃料罐"
	desc = "一个通常装有超浓稠凝固汽油的燃料罐, 这是一种粘性可燃液体化学品, 用于FL-240焚化器单元. 小心处理."
...
/obj/item/ammo_magazine/flamer_tank/mini
	name = "微型焚化器燃料罐"
	desc = "一个通常装有超浓稠凝固汽油的燃料罐, 这是一种粘性可燃液体化学品, 用于地下焚化器单元. 小心处理."
...
/obj/item/ammo_magazine/flamer_tank/afterattack(obj/target, mob/user , flag) //refuel at fueltanks when we run out of ammo.
	...
	if(!istype(target, /obj/structure/reagent_dispensers) || get_dist(user, target) > 1)
		return ..()
	if(!dispenser_type)
		to_chat(user, span_warning("这个不可加注!"))
		return ..()
	...
	to_chat(user, span_notice("你用[lowertext(caliber)]加注了[src]."))
	update_icon()
...
/obj/item/ammo_magazine/flamer_tank/mini/X
	name = "微型焚化器燃料罐 (X)"
	desc = "一个装有超浓稠X型凝固汽油燃料的大型燃料罐, 这是一种燃烧温度极高的粘性可燃液体化学品, 用于地下焚化器单元. 小心处理."
...
/obj/item/ammo_magazine/flamer_tank/mini/G
	name = "微型焚化器燃料罐 (G)"
	desc = "一个巨大的超浓稠等离子燃料罐,燃料类型G,一种粘稠的可燃液体化学物质,燃烧温度极高,用于底挂式焚化器单元.小心处理."
...
/obj/item/ammo_magazine/flamer_tank/large/X/deathsquad
	name = "巨型火焰喷射器X型燃料罐"
	desc = "利用蓝空间技术,纳米传讯成功地将远超你一生所需用量的X型燃料装入了这个专用燃料罐中."
	max_rounds = 225
	current_rounds = 225
	reload_delay = 2 SECONDS
...
/obj/item/ammo_magazine/flamer_tank/backtank
	name = "背包式燃料罐"
	desc = "一种专用燃料罐,用于FL-84火焰喷射器和FL-240焚化器单元."
...
/obj/item/ammo_magazine/flamer_tank/backtank/X
	name = "背包式燃料罐(X)"
	desc = "一种专用超浓稠石脑油X型燃料罐,用于FL-84火焰喷射器和FL-240焚化器单元."
...
/obj/item/ammo_magazine/flamer_tank/backtank/G
	name = "背包式燃料罐(G)"
	desc = "一种专用等离子G型燃料罐,用于FL-84火焰喷射器和FL-240焚化器单元."
...
/obj/item/ammo_magazine/flamer_tank/water
	name = "加压水箱"
	desc = "一罐水,用于FL-84的下挂式灭火器.可用手重新装填."
...
/obj/item/ammo_magazine/flamer_tank/internal
	name = "内置燃料罐"
	desc = "一个巨大的超浓稠石脑油燃料罐,一种粘稠的可燃液体化学物质,不过你不应该看到这个."
	icon_state = ""
	max_rounds = 280
	current_rounds = 280
	reload_delay = 0 SECONDS
