...
/obj/item/reagent_containers/food/snacks/grown/harebell
	name = "蓝铃花"
	desc = "\"我会让你的凄凉坟墓变得甜美:你不会缺少那朵像你脸庞的花,苍白的报春花,也不会缺少那蔚蓝的蓝铃花,像你的血管;不,也不会缺少那野蔷薇的叶子,并非要诋毁它,它可甜不过你的气息.\""
	icon_state = "harebell"
	potency = 1
...
/obj/item/reagent_containers/food/snacks/grown/potato/attackby(obj/item/I, mob/user, params)
	...
	if(iscablecoil(I))
		...
		to_chat(user, span_notice("你在土豆上接了些电线,然后把它滑进电池外壳里."))
...
/obj/item/reagent_containers/food/snacks/grown/pumpkin/attackby(obj/item/I, mob/user, param)
	...
	if(I.sharp == IS_SHARP_ITEM_ACCURATE || I.sharp == IS_SHARP_ITEM_BIG)
		to_chat(user, span_notice("你在[src]上刻出一张脸!"))
...
/obj/item/reagent_containers/food/snacks/grown/tomato
	name = "番茄"
	desc = "我说 to-mah-to, 你说 tom-mae-to."
	icon_state = "tomato"
	filling_color = "#FF0000"
	potency = 10
	plantname = "tomato"
...
/obj/item/reagent_containers/food/snacks/grown/tomato/throw_impact(atom/hit_atom)
	...
	src.visible_message(span_notice("[src.name]被压扁了."),span_moderate("你听到啪的一声."))
	qdel(src)

/obj/item/reagent_containers/food/snacks/grown/killertomato
	name = "杀手番茄"
	desc = "我说 to-mah-to, 你说 tom-mae-to... 天啊它在吃我的腿!!"
...
/obj/item/reagent_containers/food/snacks/grown/bluetomato
	name = "蓝番茄"
	desc = "我说 blue-mah-to, 你说 blue-mae-to."
...
/obj/item/reagent_containers/food/snacks/grown/kudzupod
	name = "葛藤荚"
	desc = "<I>Pueraria Virallis</I>: 一种入侵物种, 其藤蔓会迅速蔓延并缠绕住接触到的任何东西."
	icon_state = "kudzupod"
...
/obj/item/reagent_containers/food/snacks/grown/mushroom/reishi
	name = "灵芝"
	desc = "<I>Ganoderma lucidum</I>: 一种特殊的真菌, 据信有助于缓解压力."
	icon_state = "reishi"
	potency = 10
...
/obj/item/reagent_containers/food/snacks/grown/mushroom/amanita
	name = "毒蝇伞"
	desc = "<I>Amanita Muscaria</I>: 熟记毒蘑菇. 只采摘你认识的蘑菇."
	icon_state = "amanita"
	potency = 10
	filling_color = "#FF0000"
	plantname = "amanita"
...
/obj/item/reagent_containers/food/snacks/grown/mushroom/angel
	name = "毁灭天使"
	desc = "<I>Amanita Virosa</I>: 充满alpha鹅膏毒肽的致命毒性担子菌真菌."
	icon_state = "angel"
	potency = 35
...
/obj/item/reagent_containers/food/snacks/grown/mushroom/chanterelle
	name = "鸡油菌丛"
	desc = "<I>Cantharellus Cibarius</I>: 这些快活的黄色小蘑菇看起来确实很美味!"
...
/obj/item/reagent_containers/food/snacks/grown/mushroom/glowshroom
	name = "发光蘑菇丛"
	desc = "<I>Mycena Bregprox</I>: 这种蘑菇在黑暗中发光. 还是说它不发光?"
	...
	switch(rand(1,2))//Decides randomly to teleport the thrower or the throwee.
		...
		if(2) //Teleports mob the tomato hit instead.
			for(var/mob/A in get_turf(hit_atom))//For the mobs in the tile that was hit...
				...
				s.start()
	new/obj/effect/decal/cleanable/blood/oil(loc)
	visible_message(span_notice("[name]被压扁了, 导致时空扭曲."), span_moderate("你听到啪叽声和噼啪声."))
	qdel(src)
