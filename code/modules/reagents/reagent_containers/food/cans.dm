...
/obj/item/reagent_containers/food/drinks/cans/attack_self(mob/user as mob)
	if(canopened == FALSE)
		...
		to_chat(user, span_notice("你啪的一声打开了饮料,[pick("an audible", "a satisfying")]!"))
		canopened = TRUE
		ENABLE_BITFIELD(reagents.reagent_flags, OPENCONTAINER_NOUNIT)
		return
	var/obj/item/reagent_containers/H = usr.get_active_held_item()
	var/N = tgui_input_list(user, "每次转移量:","[H]", possible_transfer_amounts)
	if (N)
...
/obj/item/reagent_containers/food/drinks/cans/thirteenloko
	name = "\improper 十三号 Lokó"
	desc = "首席医疗官已告知船员,饮用十三号 Lokó 可能导致癫痫发作、失明、醉酒,甚至死亡。请理性饮酒。"
...
/obj/item/reagent_containers/food/drinks/cans/sodawater
	name = "苏打水"
	desc = "一罐苏打水。自来水更清爽的表亲...根据那些欧洲佬的说法。"
	icon_state = "sodawater"
	center_of_mass = list("x"=16, "y"=10)
	list_reagents = list(/datum/reagent/consumable/sodawater = 50)

/obj/item/reagent_containers/food/drinks/cans/souto
	name = "\improper Souto 经典"
	desc = "罐头大胆宣称它是橘子味的. 你忍不住觉得那是骗人的. 在哈瓦那罐装."
...
/obj/item/reagent_containers/food/drinks/cans/souto/cherry/diet
	name = "\improper 无糖樱桃索托"
	desc = "它既不是无糖的也不是樱桃味的. 在哈瓦那罐装."
...
/obj/item/reagent_containers/food/drinks/cans/aspen
	...
	desc = "当你忽略它尝起来像尿这个事实后, 其实还不错. 由纳米传讯罐装."
	icon_state = "6_pack_1"
	center_of_mass = list("x"=16, "y"=10)
...
/obj/item/reagent_containers/food/drinks/cans/souto/lime/diet
	name = "\improper 无糖青柠索托"
	desc = "十种酸, 两杯假糖, 几乎一整罐二氧化碳, 还有大约210千帕全塞进一个铝罐里. 有什么理由不爱呢? 在哈瓦那罐装."
...
/obj/item/reagent_containers/food/drinks/cans/souto/grape
	name = "\improper 葡萄索托"
	desc = "汽水口味中的老牌选择. 然而这个尝起来像葡萄味的止咳糖浆. 在哈瓦那罐装."
...
/obj/item/reagent_containers/food/drinks/cans/souto/grape/diet
	name = "\improper 无糖葡萄索托"
	desc = "你相当确定这只是葡萄止咳糖浆加碳酸水. 在哈瓦那罐装."
