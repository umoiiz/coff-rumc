...
/obj/item/reagent_containers/food/snacks/pastries/pie
	name = "香蕉奶油派"
	desc = "就像回到家乡一样,在 clown planet! HONK!"
	icon_state = "pie"
...
/obj/item/reagent_containers/food/snacks/pastries/pie/throw_impact(atom/hit_atom)
	...
	visible_message(span_warning("[src.name] 啪叽一声."),span_warning("你听到啪叽一声."))
	qdel(src)
...
/obj/item/reagent_containers/food/snacks/pastries/bsvcslice
	name = "草莓巧克力蛋糕切片"
	desc = "只是一片蛋糕,上面放着五颗草莓.不知为何,这种蛋糕配置对SELF中的AI来说特别美观." //yes, I know the one referenced has cherries, but I'm not implementing a new cake today.
...
/obj/item/reagent_containers/food/snacks/sliceable/pastries/pavlova
	name = "帕芙洛娃"
	desc = "一个甜浆果帕芙洛娃.在新西兰发明,但以一位俄罗斯芭蕾舞演员命名...并且科学证明它在晚宴上是最棒的!"
	icon_state = "pavlova"
...
/obj/item/reagent_containers/food/snacks/pastries/cakeslicepavlova
	name = "帕芙洛娃切片"
	desc = "一片堆满浆果的碎帕芙洛娃.你甚至切得让更多浆果落到了你的那片上,真是令人愉快的恶魔."
...
/obj/item/reagent_containers/food/snacks/sliceable/pastries/frenchsilkpie
	name = "法式丝绸派"
	desc = "一个颓废的派,由奶油巧克力慕斯馅料制成,上面铺有一层鲜奶油和巧克力碎屑.可切片."
...
/obj/item/reagent_containers/food/snacks/pastries/frenchsilkpieslice
	name = "法式丝绸派切片"
	desc = "一片法式丝绸派,填满巧克力慕斯,上面铺有一层鲜奶油和巧克力碎屑.美味到让你哭泣."
...
/obj/item/reagent_containers/food/snacks/pastries/cocolavatart
	name = "巧克力熔岩挞"
	desc = "一个由巧克力制成的美味甜点,带有液体核心." //But it doesn't even contain chocolate...
