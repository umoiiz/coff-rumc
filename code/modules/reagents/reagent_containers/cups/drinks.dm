...
/obj/item/reagent_containers/cup/glass/mug/tea
	name = "紫公爵茶"
	desc = "侮辱紫公爵就是侮辱太空女王! 任何正派的绅士都会为了你玷污这茶而跟你决斗."
	icon_state = "tea"
...
/obj/item/reagent_containers/cup/glass/coffee_cup
	name = "咖啡杯"
	desc = "一个热成型的塑料咖啡杯. 理论上也可以用来装其他热饮,如果你够胆的话."
	icon = 'icons/obj/drinks/coffee.dmi'
...
/obj/item/reagent_containers/cup/glass/dry_ramen
	name = "杯面"
	desc = "只需加入5毫升水,自加热! 让你想起学生时代的味道. 全新咸香口味!"
	icon_state = "ramen"
...
/obj/item/reagent_containers/cup/glass/waterbottle/throw_impact(atom/hit_atom, speed, bounce)
	...
	if(prob(flip_chance)) // landed upright
		visible_message(span_notice("[src]直立着落地了!"))
...
/obj/item/reagent_containers/cup/glass/waterbottle/relic
	name = "神秘瓶子"
	desc = "一个与水瓶颇为相似的瓶子,但上面用记号笔潦草地写着一些字. 它似乎在散发某种能量."
...
/obj/item/reagent_containers/cup/glass/colocup
	name = "可乐杯"
	desc = "一种廉价、大规模生产的杯子,通常用于派对. 不知为何,它们似乎从来都不是红色的..."
...
/obj/item/reagent_containers/cup/glass/flask
	name = "随身酒壶"
	desc = "每个优秀的太空人都知道,无论去哪都随身带上几品脱威士忌是个好主意."
	icon = 'icons/obj/drinks/bottles.dmi'
	icon_state = "flask"
	volume = 60
	can_shatter = FALSE
