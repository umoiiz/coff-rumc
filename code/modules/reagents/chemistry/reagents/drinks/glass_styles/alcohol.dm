...
/datum/glass_style/drinking_glass/grappa
	...
	desc = "一种上等饮品,最初是为了利用酿酒剩下的残渣避免浪费而制成。"
	icon_state = "grappa"
...
/datum/glass_style/drinking_glass/patron
	...
	desc = "在酒吧里喝着 patron,身边全是些不入流的女士。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/fernet
	...
	desc = "一杯纯苦艾酒。只有绝对的疯子才会独自喝这个。" //Hi Kevum
...
/datum/glass_style/drinking_glass/pruno
	...
	name = "glass of pruno"
	desc = "用水果、糖和绝望发酵而成的监狱酒。安保最爱没收这个,这是安保做过唯一善良的事。"
