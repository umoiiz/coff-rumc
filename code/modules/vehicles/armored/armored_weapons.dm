/obj/item/armored_weapon
	...
	desc = "一种TGMC载具的主炮塔火炮. 它发射86毫米火箭推进炮弹"
...
/obj/item/armored_weapon/tank_autocannon
	name = "\improper Bushwhacker自动机炮"
	desc = "一种用于载具的Bushwhacker 30毫米自动机炮."
...
/obj/item/armored_weapon/apc_cannon
	name = "\improper MKV-7多用途载荷发射器"
	desc = "一种双管火炮, 可以快速向战场部署多用途载荷包."
...
/obj/item/armored_weapon/secondary_flamer
	...
	desc = "一种大型载具搭载火焰喷射器. 这一款由于混合物较不浓稠, 能够喷洒其燃料."
	icon_state = "sflamer"
...
/obj/item/armored_weapon/tow
	...
	desc = "一种单发, 寻的, 载具搭载的TOW-III发射器, 专为对装甲目标进行精确打击而设计. 配备IFF."
	icon_state = "seeker"
...
/obj/item/armored_weapon/microrocket_pod
	name = "微型火箭巢"
	desc = "一种TGMC副载具搭载多管火箭系统, 共有6枚寻的微型火箭. 能够快速连续释放其全部载荷."
...
/obj/item/armored_weapon/bfg
	...
	desc = "一种噼啪作响的能量武器, 是经典BFG 9000的略微放大版. 对准那些杀了你兔子的人."
	icon_state = "bfg"
...
/obj/item/armored_weapon/lvrt_sarden
	name = "\improper EM-2600 'SARDEN'自动机炮"
	desc = "一种用于LVRT 'Fallow'的30毫米自动机炮. 一种出乎意料的强大自动机炮. 遗憾的是, 弹链供弹系统在与该系统相关的预算削减浪潮中丢失了. 它装填4发弹夹."
...
/obj/item/armored_weapon/lvrt_cannon
	...
	desc = "一种用于LVRT 'Fallow'的76毫米低速炮. 它的弹速较慢, 但爆炸性能扎实. 它装填76毫米炮弹."
...
/obj/item/armored_weapon/lvrt_flamer
	name = "\improper EM-2400低冲量火焰喷射器"
	desc = "一种用于LVRT 'Fallow'的40毫米低冲量火焰喷射器. 凭借其特殊设计, 向小范围区域发射火球. 专为对抗柔软有机结构而制造. 使用特殊的高燃烧性燃料混合物."
...
/obj/item/armored_weapon/coaxial
	name = "EM-94同轴链式机炮 (10x26毫米)"
	desc = "一种弹链供弹的同轴机炮, 倾泻铅弹. 无论如何都需要载具的枪管护罩和动力系统才能使用. 可以使用标准MG-60弹箱或载具专用弹箱."
