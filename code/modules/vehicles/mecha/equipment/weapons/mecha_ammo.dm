...
/obj/item/mecha_ammo/attack_self(mob/user)
	...
	to_chat(user, span_notice("你将[src]压平."))
...
/obj/item/mecha_ammo/lmg
	name = "机枪弹药箱"
	desc = "一箱弹链弹药,专为Ultra AC 2外骨骼武器设计."
	icon_state = "lmg"
	rounds = 300
...
/obj/item/mecha_ammo/flashbang
	name = "可发射闪光弹"
	desc = "一箱光滑闪光弹,用于大型外骨骼发射器.无法手动拔销."
...
/obj/item/mecha_ammo/clusterbang
	name = "可发射集束闪光弹"
	desc = "一箱集束闪光弹,用于专用外骨骼集束发射器.无法手动拔销."
...
/obj/item/mecha_ammo/vendable/rifle
	name = "步枪子弹箱"
	desc = "一箱大型火箭助推步枪子弹.侧面写着\"请勿当作鞭炮使用\"."
...
/obj/item/mecha_ammo/vendable/burstrifle
	name = "爆裂步枪子弹箱"
	desc = "一箱大型火箭助推爆裂步枪子弹.侧面写着\"请勿当作鞭炮使用\"."
...
/obj/item/mecha_ammo/vendable/shotgun
	name = "霰弹枪弹壳箱"
	desc = "一箱大型霰弹枪弹壳.可惜它们只能装进机甲尺寸的武器."
...
/obj/item/mecha_ammo/vendable/rpg
	name = "高爆导弹"
	desc = "一枚TGMC机甲导弹.你大概不该用任何东西去撞那个尖头."
	icon_state = "rpg_ammo"
	rounds = 1
...
/obj/item/mecha_ammo/vendable/minigun
	name = "火神机炮子弹箱"
	desc = "对你来说很不幸,火神机炮射出的每一发子弹也都必须装填进去."
...
/obj/item/mecha_ammo/vendable/sniper
	name = "狙击枪子弹箱"
	desc = "一箱反坦克子弹,用于射击小型装甲车辆和小型装甲生物."
...
/obj/item/mecha_ammo/vendable/flamer
	name = "火焰喷射器凝固汽油罐"
	desc = "一个专用燃料罐,用于为TGMC标准配发机甲火焰喷射器补充燃料."
