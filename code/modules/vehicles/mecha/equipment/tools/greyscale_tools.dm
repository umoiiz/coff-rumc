...
/obj/item/mecha_parts/mecha_equipment/generator/greyscale
	name = "佛隆引擎"
	desc = "一种先进的纳米特雷森佛隆引擎核心原型,专为TGMC先进机甲外骨骼设计.使用固态佛隆作为燃料,点击引擎进行加注.最轻的引擎,机甲可以使用,但代价是充能速率和最大燃料容量."
...
/obj/item/mecha_parts/mecha_equipment/generator/greyscale/upgraded
	name = "聚变引擎"
	desc = "一种高度实验性的佛隆聚变核心.在相同消耗率下产生更多动力,但比标准佛隆引擎更拖慢你的速度.使用固态佛隆作为燃料,点击引擎进行加注.最重的引擎,机甲可以使用,但代价是因重量而降低速度."
...
/obj/item/mecha_parts/mecha_equipment/energy_optimizer
	name = "能量优化器"
	desc = "一种纳米特雷森品牌的计算机,使用预测算法将所有步骤的能耗降低50%."
...
/obj/item/mecha_parts/mecha_equipment/melee_core
	name = "近战核心"
	desc = "一种蓝空间猎户座-斯佩尔科夫转换器.通过你懒得去理解的科学原理,使机甲更快,其武器能够汲取更多动力,使其更加危险.然而代价是无法使用投射物和激光武器."
...
/obj/item/mecha_parts/mecha_equipment/ability/dash
	name = "执行器安全超控"
	desc = "一堆杂乱的电子设备,允许用户超控标准安全输入以提高速度,代价是极高的能耗."
	icon_state = "booster"
	can_equip = TRUE
...
/obj/item/mecha_parts/mecha_equipment/ability/zoom
	name = "增强变焦"
	desc = "一种放大模块,允许驾驶员比标准光学设备看得远得多.不包含夜视功能."
	icon_state = "zoom"
	can_equip = TRUE
...
/obj/item/mecha_parts/mecha_equipment/ability/smoke/tanglefoot
	name = "缠足发生器"
	desc = "一种绊足烟雾发生器,能够释放大量非致命气体,削弱任何接触到它的异形生物的能量."
...
/obj/item/mecha_parts/mecha_equipment/ability/smoke/cloak_smoke
	name = "烟雾发生器"
	desc = "一种多联发射模块,能够生成大量遮蔽烟雾以掩护附近的友军.遗憾的是,巨大的机器人太难用它来隐藏了."
