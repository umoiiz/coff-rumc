/mob/living/carbon/xenomorph/predalien
	...
	desc = "一种外表奇怪的生物,头部有肉质的丝状物.它看起来像是护甲与血肉的混合体,光滑,但甲壳坚固."
...
/mob/living/carbon/xenomorph/predalien/proc/announce_spawn()
	...
	to_chat(src, {"
		...
		<span class='role_header'>你是一个铁血异形混种!</span>
		<span class='role_body'>你是一种非常强大的异形生物,由一名亚乌查战士的身体诞生.
		你比普通异形更强壮,更快速,更聪明,但你仍然必须听从巢穴统治者的命令.
		你有一定程度的自由,可以去狩猎并夺取巢穴敌人的首级,所以查看你的指令.
		你的生命值不会正常再生,所以为巢穴杀戮和死亡吧!</span>
		<span class='role_body'>|______________________|</span>
	"})
	emote("roar")
