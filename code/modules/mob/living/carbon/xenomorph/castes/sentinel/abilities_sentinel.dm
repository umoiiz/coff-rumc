...
/datum/action/ability/activable/xeno/xeno_spit/toxic_spit
	name = "Toxic Spit"
	desc = "向最远7格外的目标吐出毒素, 造成中毒减益并持续造成伤害."
...
/datum/action/ability/xeno_action/toxic_slash
	name = "Toxic Slash"
	desc = "在短时间内用酸液灌注你的爪子, 对受害者造成持久效果."
...
/datum/action/ability/xeno_action/toxic_slash/action_activate()
	...
	xeno_owner.balloon_alert(xeno_owner, "毒性斩击激活")
...
/datum/action/ability/xeno_action/toxic_slash/proc/toxic_slash_deactivate(mob/living/carbon/xenomorph/xeno_owner)
	...
	xeno_owner.balloon_alert(xeno_owner, "毒性斩击结束") //Let the user know
...
/datum/action/ability/xeno_action/toxic_slash/on_cooldown_finish()
	...
	owner.balloon_alert(owner, "毒性斩击就绪")
	return ..()
...
/datum/action/ability/activable/xeno/drain_sting
	name = "Drain Sting"
	desc = "刺击你的受害者, 吸取他们, 如果目标中毒则获得额外收益."
...
/datum/action/ability/activable/xeno/drain_sting/use_ability(atom/A)
	...
	xeno_owner.visible_message(message = span_xenowarning("\A [xeno_owner]刺击了[human_target]!"), self_message = span_xenowarning("我们刺击了[human_target]!"))
...
/datum/action/ability/activable/xeno/drain_sting/on_cooldown_finish()
	...
	owner.balloon_alert(owner, "吸血刺就绪")
	return ..()
...
/datum/action/ability/activable/xeno/toxic_grenade
	name = "Toxic grenade"
	desc = "投掷一团压缩酸性气体, 会持续造成伤害并使受害者中毒."
...
/datum/action/ability/activable/xeno/toxic_grenade/proc/grenade_act(atom/our_atom)
	...
	nade.activate(owner)
	owner.visible_message(span_warning("[owner]吐出一个球状团块并将其扔向[our_atom]!"), span_warning("我们吐出一个球状团块并将其扔向[our_atom]!"))

/obj/item/explosive/grenade/smokebomb/xeno
	name = "毒性手雷"
	desc = "一个肉块在地上弹跳. 它似乎在升温."
