...
/datum/action/ability/xeno_action/acid_charge
	name = "Acid Charge"
	desc = "酸液冲锋, 对你自己造成少量伤害, 并在你的脚步后开始留下酸液水洼."
...
/datum/action/ability/xeno_action/gore/proc/bull_charge_slash(datum/source, mob/living/target, damage, list/damage_mod)
	...
	target.emote_gored()
	xeno_owner.visible_message(span_danger("[xeno_owner]刺穿了[target]!"),
		span_xenowarning("我们刺穿[target]并滑行停下!"))
...
/datum/action/ability/xeno_action/tolerate
	name = "Tolerate"
	desc = "在接下来的几秒内, 你将变得对减速, 硬直和眩晕具有抗性."
