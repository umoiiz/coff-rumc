...
/mob/living/simple_animal/corgi/ranger
	...
	real_name = "Ranger"
	gender = MALE
	desc = "那是兰杰,你友好而凶猛的警犬. 他见识过异形的恐怖,所以最好对他好一点. <b>兰杰带路</b>!"
	icon_state = "ranger"
	icon_living = "ranger"
...
/mob/living/simple_animal/corgi/walten
	...
	gender = MALE
	desc = "长官,这是沃尔滕·克莱门茨队长. 他住在医疗湾,因为这里也是他的领地. 他的手下穿着手术服以控制细菌,他们用抚摸和零食来孝敬他. 不要担心他会得慢性阻塞性肺病,因为他保持着健康的饮食,充满黑咖啡,还有大量的有氧运动和伸展运动. 他每天操心的是记账; 他的零食供应必须得到密切关注. 你好,陆战队员."
	icon = 'icons/mob/pets.dmi'
	icon_state = "walten"
	icon_living = "walten"
