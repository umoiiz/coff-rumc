...
/obj/item/clothing/gloves/botanic_leather
	desc = "这些皮革手套可防护荆棘,倒刺,尖刺,尖桩以及其他植物来源的有害物体."
	name = "植物学家皮革手套"
	icon_state = "leather"
...
/obj/item/weapon/heldglove/boxing/attack(mob/living/M, mob/living/user)
	...
	target.balloon_alert_to_viewers("[target]精疲力竭地倒在地上!K.O!", "你放弃并倒下!K.O!")
...
/obj/structure/punching_bag
	name = "沙袋"
	desc = "一个纳米传讯的沙袋. 在远离太阳系的这里很常见.\nCheap而且很脆弱, 被太重的东西击中可能会破裂."
