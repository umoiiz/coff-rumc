/obj/item/clothing/gloves/marine
	name = "陆战队战斗手套"
	desc = "标准配发的陆战队战术手套.上面写着:'由陆战队遗孀协会编织'."
...
/obj/item/clothing/gloves/marine/black
	name = "黑色陆战队战斗手套"
	desc = "标准配发的陆战队战术手套,但是黑色的!上面写着:'由陆战队遗孀协会编织'."
	icon_state = "gloves_marine_black"
	worn_icon_state = "black"

/obj/item/clothing/gloves/marine/insulated
	name = "绝缘陆战队战斗手套"
	desc = "绝缘的陆战队战术手套,可防护电击."
...
/obj/item/clothing/gloves/marine/som/veteran
	...
	desc = "起源可追溯到旧采矿殖民地的手套.这些似乎比普通的更坚固."
...
/obj/item/clothing/gloves/marine/icc/insulated
	...
	desc = "看起来结实的工作手套.这些似乎带有绝缘层以防护电击."
	siemens_coefficient = 0
...
/obj/item/clothing/gloves/marine/commissar
	name = "\improper 政委手套"
	desc = "帝国陆军政委佩戴的手套,这样他们就不会被部下的血弄脏双手."
	icon_state = "red"
...
/obj/item/clothing/gloves/marine/separatist
	name = "TG-94凯夫拉手套"
	desc = "曾几何时,这些手套的原型在泰拉殖民地英勇解放其领土的战斗中,保护了殖民地民兵的双手免受敌人之手.'带着荣誉佩戴它,'底部的铭文如此写道"
	icon_state = "separatist"
	worn_icon_state = "separatist"

/obj/item/clothing/gloves/marine/veteran/marine
	name = "老兵手套"
	desc = "普通的陆战队手套,为个人利益而巧妙加固.一块额外的钢板和一对酷炫的白色鞋带绝对会让这件物品看起来更好.你确信如此.陆战队遗孀协会对此感到愤怒."
...
/obj/item/clothing/gloves/marine/veteran/marine/examine(mob/user)
	. = ..()
	. += span_info("你可以在手中<b>使用它</b>将其翻面并改变外观.")

/obj/item/clothing/gloves/marine/veteran/marine/attack_self(mob/user)
	. = ..()
	if(!gloves_inside_out)
		to_chat(user, span_notice("你将手套翻面并改变了它们的外观."))
		gloves_inside_out = TRUE
	else
		to_chat(user, span_notice("你将手套翻回内侧,它们看起来恰到好处."))
