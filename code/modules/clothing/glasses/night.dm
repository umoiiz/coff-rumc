...
/obj/item/clothing/glasses/night/tx8
	...
	desc = "用于BR-8战斗步枪的头戴式夜视护目镜系统.可对周围环境进行高亮成像.点击切换."
...
/obj/item/clothing/glasses/night/m42_night_goggles
	...
	desc = "用于M42侦察步枪的头戴式夜视护目镜系统.可对周围环境进行高亮成像.点击切换."
	icon_state = "m56_goggles"
	deactive_state = "m56_goggles_0"
	vision_flags = SEE_TURFS
	toggleable = TRUE
...
/obj/item/clothing/glasses/night/m56_goggles
	...
	desc = "一种与任何KTLD武器(例如SG系列武器)配套使用的头戴式护目镜系统.具有低分辨率短程成像仪,可用于观察地形."
	icon_state = "m56_goggles"
	deactive_state = "m56_goggles_0"
	toggleable = TRUE
	vision_flags = SEE_TURFS
...
/obj/item/clothing/glasses/night/sunglasses
	...
	desc = "一副设计师太阳镜.这副太阳镜装有KTLD头戴式瞄具."
...
/obj/item/clothing/glasses/night_vision
	...
	desc = "用于在低光条件下更清晰地视物并保持对周围环境的观察的护目镜."
...
/obj/item/clothing/glasses/night_vision/proc/battery_status()
	if(battery)
		return span_notice("电池:[battery.charge]/[battery.maxcharge]")
...
/obj/item/clothing/glasses/night_vision/mounted
	...
	desc = "用于在低光条件下更清晰地视物的护目镜.必须保持连接在头盔上."
...
/obj/item/clothing/glasses/night/vsd
	...
	desc = "V.S.D的标准配发夜视护目镜!为了额外的战术酷炫感!坠毁核心和你的上级军官不对失明和灼伤负责."
