/obj/item/clothing/glasses/meson
	name = "光学介子扫描仪"
	desc = "用于保护使用者的眼睛免受有害电磁辐射,也用作一般安全护目镜.不足以作为焊接防护."
	icon_state = "meson"
...
/obj/item/clothing/glasses/meson/enggoggles
	...
	desc = "TGMC标准配发护目镜.这副护目镜内部装有光学介子扫描仪."
