...
/obj/item/clothing/suit/armor/mob_can_equip(mob/user, slot, warning = TRUE, override_nodrop = FALSE, bitslot = FALSE)
	...
	if(!H.w_uniform)
		to_chat(H, span_warning("你需要在里面穿点东西才能装备它."))
		return FALSE
...
/obj/item/clothing/suit/armor/bulletproof
	name = "防弹背心"
	desc = "一件在保护穿戴者抵御高速实弹射弹方面表现出色的背心."
...
/obj/item/clothing/suit/armor/riot
	name = "防暴服"
	desc = "一套带有厚重衬垫以抵御近战攻击的装甲. 看起来可能会影响行动."
	icon_state = "riot"
...
/obj/item/clothing/suit/armor/patrol
	name = "安保巡逻装甲"
	desc = "一套供安保人员在巡逻时使用的轻型装甲. 虽然比凯夫拉更先进, 但更重, 会稍微减慢穿戴者的速度."
...
/obj/item/clothing/suit/armor/sectoid
	name = "灵能场"
	desc = "一片无形的能量场, 它保护穿戴者但会阻止穿戴任何衣物."
