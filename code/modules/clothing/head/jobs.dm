/obj/item/clothing/head/chefhat
	name = "厨师帽"
	desc = "厨师用来防止头发掉进食物里的帽子. 从食堂里的食物来看, 它们没什么用."
	icon_state = "chefhat"
...
/obj/item/clothing/head/beret/jan
	name = "紫色贝雷帽"
	desc = "一顶时尚的,虽然说是紫色的,贝雷帽."
	icon_state = "purpleberet"

//Medical
/obj/item/clothing/head/surgery
	name = "手术帽"
	desc = "外科医生在手术时戴的帽子.防止他们的头发挠到你的内脏."
	icon_state = "surgcap_blue"
	inv_hide_flags = HIDETOPHAIR
	species_exception = list(/datum/species/robot)

/obj/item/clothing/head/surgery/purple
	desc = "外科医生在手术时戴的帽子.防止他们的头发挠到你的内脏.这顶是深紫色的."
	icon_state = "surgcap_purple"

/obj/item/clothing/head/surgery/blue
	desc = "外科医生在手术时戴的帽子.防止他们的头发挠到你的内脏.这顶是淡蓝色的."
	icon_state = "surgcap_blue"

/obj/item/clothing/head/surgery/green
	desc = "外科医生在手术时戴的帽子.防止他们的头发挠到你的内脏.这顶是深绿色的."
