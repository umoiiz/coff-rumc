...
/obj/item/clothing/suit/modular/jaeger
	...
	desc = "一种步兵型猎兵战斗外骨骼, 可与模块化附件配合使用, 以便在多种环境中发挥作用. 这个似乎具有中等数量的护甲板. 按住Alt并点击以移除附加物品. 使用它来切换内置手电筒."
...
/obj/item/clothing/suit/modular/jaeger/eva
	...
	desc = "一种EVA型猎兵战斗外骨骼, 可与模块化附件配合使用, 以便在多种环境中发挥作用. 这个似乎具有中等数量的护甲板. 按住Alt并点击以移除附加物品. 使用它来切换内置手电筒."
...
/obj/item/clothing/suit/modular/jaeger/helljumper
	...
	desc = "一种地狱伞兵型猎兵战斗外骨骼, 可与模块化附件配合使用, 以便在多种环境中发挥作用. 这个似乎具有中等数量的护甲板. 按住Alt并点击以移除附加物品. 使用它来切换内置手电筒."
...
/obj/item/clothing/suit/modular/jaeger/ranger
	...
	desc = "一种游骑兵型猎兵战斗外骨骼, 可与模块化附件配合使用, 以便在多种环境中发挥作用. 这个似乎具有中等数量的护甲板. 按住Alt并点击以移除附加物品. 使用它来切换内置手电筒."
...
/obj/item/clothing/suit/modular/jaeger/hotaru
	...
	desc = "一种游骑兵型萤火虫战斗外骨骼, 可与模块化附件配合使用, 以便在多种环境中发挥作用. 这个似乎具有中等数量的护甲板. 按住Alt并点击以移除附加物品. 使用它来切换内置手电筒."
...
/obj/item/clothing/suit/modular/jaeger/light
	...
	desc = "一种侦察兵型猎兵战斗外骨骼, 可与模块化附件配合使用, 以便在多种环境中发挥作用. 这个似乎具有轻量数量的护甲板. 按住Alt并点击以移除附加物品. 使用它来切换内置手电筒."
...
/obj/item/clothing/suit/modular/jaeger/light/skirmisher
	...
	desc = "一种散兵型猎兵战斗外骨骼, 可与模块化附件配合使用, 以便在多种环境中发挥作用. 这个似乎具有轻量数量的护甲板. 按住Alt并点击以移除附加物品. 使用它来切换内置手电筒."
...
/obj/item/clothing/suit/modular/jaeger/light/trooper
	...
	desc = "一种步兵型猎兵战斗外骨骼, 可与模块化附件配合使用, 以便在多种环境中发挥作用. 这个似乎具有轻量数量的护甲板. 按住Alt并点击以移除附加物品. 使用它来切换内置手电筒."
...
/obj/item/clothing/suit/modular/jaeger/heavy
	...
	desc = "一种冈格尼尔型猎兵战斗外骨骼, 可与模块化附件配合使用, 以便在多种环境中发挥作用. 这个似乎具有高数量的护甲板. 按住Alt并点击以移除附加物品. 使用它来切换内置手电筒."
...
/obj/item/clothing/suit/modular/jaeger/heavy/assault
	...
	desc = "一种突击型猎兵战斗外骨骼, 可与模块化附件配合使用, 以便在多种环境中发挥作用. 这个似乎具有高数量的护甲板. 按住Alt并点击以移除附加物品. 使用它来切换内置手电筒."
	greyscale_config = /datum/greyscale_config/armor_mk2

/obj/item/clothing/suit/modular/jaeger/heavy/eod
	name = "\improper 猎兵排爆重型外骨骼"
	desc = "一种排爆型猎兵战斗外骨骼, 可与模块化附件配合使用, 以便在多种环境中发挥作用. 这个似乎具有高数量的护甲板. 按住Alt并点击以移除附加物品. 使用它来切换内置手电筒."
	greyscale_config = /datum/greyscale_config/armor_mk2/eod

//jaeger hats
/obj/item/clothing/head/modular/marine
	name = "猎兵型步兵头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用. 可以在头盔挂载点上安装实用功能. 带有步兵标记."
	worn_icon_list = list(
...
/obj/item/clothing/head/modular/marine/eva
	name = "猎兵型EVA头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用. 可以在头盔挂载点上安装实用功能. 带有EVA标记."
...
/obj/item/clothing/head/modular/marine/skirmisher
	name = "猎兵型散兵头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用. 可以在头盔挂载点上安装实用功能. 带有散兵标记."
...
/obj/item/clothing/head/modular/marine/scout
	name = "猎兵型侦察兵头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用. 可以在头盔挂载点上安装实用功能. 带有侦察兵标记"
...
/obj/item/clothing/head/modular/marine/gungnir
	name = "猎兵型冈格尼尔头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用. 可以在头盔挂载点上安装实用功能. 带有冈格尼尔标记"
...
/obj/item/clothing/head/modular/marine/helljumper
	name = "猎兵型地狱伞兵头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有地狱伞兵标识"
...
/obj/item/clothing/head/modular/marine/ranger
	name = "猎兵型游骑兵头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有游骑兵标识"
...
/obj/item/clothing/head/modular/marine/traditional
	name = "猎兵型传统游骑兵头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有传统游骑兵标识"
...
/obj/item/clothing/head/modular/marine/mjolnir_open
	name = "猎兵Mk.I型开放式雷神头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有雷神标识但露出下颚."
...
/obj/item/clothing/head/modular/marine/kabuto
	name = "风格型兜头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有兜标识"
...
/obj/item/clothing/head/modular/marine/hotaru
	name = "风格型萤火虫头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有萤火虫标识"
...
/obj/item/clothing/head/modular/marine/dashe
	name = "风格型冲刺头盔"
	desc = "通常与猎兵战斗外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有冲刺标识"
...
/obj/item/clothing/head/modular/marine/hardsuit_helm
	name = "斑纹科技基础硬质服头盔"
	desc = "通常与斑纹科技WY-01模块化外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有基础标识"
...
/obj/item/clothing/head/modular/marine/hardsuit_helm/markfive
	name = "斑纹科技Mark V破门者头盔"
	desc = "通常与斑纹科技WY-01模块化外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有破门者标识"
...
/obj/item/clothing/head/modular/marine/hardsuit_helm/markthree
	name = "斑纹科技Mark III掠夺者头盔"
	desc = "通常与斑纹科技WY-01模块化外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有掠夺者标识"
...
/obj/item/clothing/head/modular/marine/hardsuit_helm/markone
	name = "斑纹科技Mark I突袭者头盔"
	desc = "通常与斑纹科技WY-01模块化外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有突袭者标识"
...
/obj/item/clothing/head/modular/marine/vsd_hardsuit
	name = "粉碎者MT/41'福波斯'头盔"
	desc = "通常与粉碎核心MT/P模块化外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有'福波斯'标识"
...
/obj/item/clothing/head/modular/marine/vsd_hardsuit/clementia
	name = "粉碎者MT/41'克莱门提亚'头盔"
	desc = "通常与粉碎核心MT/P模块化外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有'克莱门提亚'标识"
...
/obj/item/clothing/head/modular/marine/vsd_hardsuit/hephaestus
	name = "粉碎者MT/41'赫菲斯托斯'头盔"
	desc = "通常与粉碎核心MT/P模块化外骨骼搭配使用.可在头盔挂载点上安装实用功能模块.带有'赫菲斯托斯'标识"
