...
/obj/item/clothing/suit/modular/robot
	name = "XR-1 护甲板"
	desc = "中型护甲板, 设计用于自行安装到TerraGov战斗机器人上. 它带有自密封螺栓, 用于安装到机器人内部."
...
/obj/item/clothing/suit/modular/robot/light
	name = "XR-1-L 护甲板"
	desc = "轻型护甲板, 设计用于自行安装到TerraGov战斗机器人上. 它带有自密封螺栓, 用于安装到机器人内部."
...
/obj/item/clothing/suit/modular/robot/heavy
	name = "XR-1-H 护甲板"
	desc = "重型护甲板, 设计用于自行安装到TerraGov战斗机器人上. 它带有自密封螺栓, 用于安装到机器人内部."
...
/obj/item/clothing/head/modular/robot
	name = "XN-1 上部护甲板"
	desc = "中型护甲板, 设计用于自行安装到TerraGov战斗机器人的上半部分. 它带有自密封螺栓, 用于安装到机器人内部."
	worn_icon_list = list(
...
/obj/item/clothing/head/modular/robot/light
	name = "XN-1-L 上部护甲板"
	desc = "轻型护甲板, 设计用于自行安装到TerraGov战斗机器人的上半部分. 它带有自密封螺栓, 用于安装到机器人内部."
...
/obj/item/clothing/head/modular/robot/heavy
	name = "XN-1-H 上部护甲板"
	desc = "重型护甲板, 设计用于自行安装到TerraGov战斗机器人的上半部分. 它带有自密封螺栓, 用于安装到机器人内部."
...
/obj/item/clothing/head/helmet/marine/robot/advanced/acid
	name = "\improper 耐酸上部护甲板"
	desc = "重型护甲板, 设计用于自行安装到TerraGov战斗机器人的上半部分. 它带有自密封螺栓, 用于安装到机器人内部. 它是为了让机器人在高酸浓度环境中生存而创造的. 使用已知的镍金板技术来保护机器人上部的重要模块"
...
/obj/item/clothing/suit/storage/marine/robot/advanced/acid
	name = "\improper 耐酸护甲板"
	desc = "重型护甲板, 设计用于自行安装到TerraGov战斗机器人上. 它带有自密封螺栓, 用于安装到机器人内部. 它是为了让机器人在高酸浓度环境中生存而创造的. 护甲使用镍和金板技术, 提供完美的防酸保护."
...
/obj/item/clothing/head/helmet/marine/robot/advanced/physical
	name = "\improper 犰狳上部护甲板"
	desc = "重型护甲板, 设计用于自行安装到TerraGov战斗机器人的上半部分. 它带有自密封螺栓, 用于安装到机器人内部. 它基于殖民地警察特种部队头盔, 并由工程师为机器人重新设计. 该头盔获得了强化内衬以及底座, 增加了对攻击性动物和枪械的防护."
...
/obj/item/clothing/suit/storage/marine/robot/advanced/physical
	name = "\improper 犰狳护甲板"
	desc = "重型护甲板, 设计用于自行安装到TerraGov战斗机器人上. 它带有自密封螺栓, 用于安装到机器人内部. 它最初是作为机器人反恐行动用的警察板甲而创造的, 但后来首席工程师们将其改造以满足TGMC的需求. 该护甲增加了额外的板甲, 以防御攻击性动物和枪械."
...
/obj/item/clothing/head/helmet/marine/robot/advanced/bomb
	name = "\improper 缓步动物上部护甲板"
	desc = "重型护甲板, 设计用于自行安装到TerraGov战斗机器人的上半部分. 它带有自密封螺栓, 用于安装到机器人内部.护甲的上半部分专为机器人设计, 因为机器人因地雷和手榴弹爆炸而失去头部的情况变得越来越频繁. 头盔与主体部分的连接经过强化, 据科学家称, 这将减少重要模块丢失的情况. 它增强了对冲击波和爆炸的防护."
...
/obj/item/clothing/suit/storage/marine/robot/advanced/bomb
	name = "\improper 缓步动物护甲板"
	desc = "重型护甲板, 设计用于自行安装到TerraGov战斗机器人上. 它带有自密封螺栓, 用于安装到机器人内部. 这款护甲专为处理爆炸物和地雷而设计. 它经常被安装在工兵和工程师的旧机器人上, 以提高它们的生存率. 该护甲配备了增强的冲击波和爆炸防护."
...
/obj/item/clothing/head/helmet/marine/robot/advanced/fire
	name = "\improper 蝾螈上部护甲板"
	desc = "重型护甲板, 设计用于自行安装到TerraGov战斗机器人的上半部分. 它带有自密封螺栓, 用于安装到机器人内部.顶部护甲由类似防火玻璃的材料制成. 这样做是为了不降低机器人追踪模块的效率. 玻璃本身可以承受高温以及短时间停留在岩浆中."
...
/obj/item/clothing/suit/storage/marine/robot/advanced/fire
	name = "\improper 蝾螈护甲板"
	desc = "重型护甲板, 设计用于自行安装到TerraGov战斗机器人上. 它带有自密封螺栓, 用于安装到机器人内部. 这款护甲的灵感来自熔岩行星上使用的采矿外骨骼. 由TeraGova工程师为使用火焰喷射器并在高温环境中工作的机器人升级. 护甲保护重要模块和线路免受火焰和岩浆的伤害, 这使机器人在火焰中具有高生存能力."
