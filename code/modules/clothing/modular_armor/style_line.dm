...
/obj/item/clothing/head/modular/style/beret
	name = "TGMC贝雷帽"
	desc = "一顶TGMC使用的帽子,通常被认为是最具标志性的军用头饰.通常留给高级军官,但偶尔也会流入小队队长和功勋卓著的大兵手中."
...
/obj/item/clothing/head/modular/style/classic_beret
	name = "TGMC贝雷帽(经典)"
	desc = "一顶TGMC使用的帽子,通常被认为是最具标志性的军用头饰.通常留给高级军官,但偶尔也会流入小队队长和功勋卓著的大兵手中.这一顶是经典款式."
...
/obj/item/clothing/head/modular/style/boonie
	name = "TGMC奔尼帽"
	desc = "一顶TGMC使用的奔尼帽,专为在阳光充足或植被茂密的环境中作战而设计."
...
/obj/item/clothing/head/modular/style/cap
	name = "TGMC巡逻帽"
	desc = "一顶TGMC使用的常见巡逻帽,时尚且有多种颜色.主要用于遮挡阳光和避开军官."
...
/obj/item/clothing/head/modular/style/slouchhat
	name = "TGMC垂边帽"
	desc = "一顶垂边帽,让你感觉身处澳洲内陆,对吧?帽子下方有\"TGMC财产\"的标记."
...
/obj/item/clothing/head/modular/style/ushanka
	name = "TGMC护耳冬帽"
	desc = "一顶TGMC使用的舒适护耳冬帽.即使在最严酷的极地环境中也能让你保持温暖."
...
/obj/item/clothing/head/modular/style/campaignhat
	name = "TGMC竞选帽"
	desc = "一顶竞选帽,光是看着它就能感受到这顶帽子散发出的威慑气场."
...
/obj/item/clothing/head/modular/style/beanie
	name = "TGMC毛线帽"
	desc = "一顶毛线帽,光是看着它就能让你感觉自己像个\"乌萨马\",或者更准确地说--一种现代现象,人们一戴上毛线帽就突然需要去卧推."
...
/obj/item/clothing/head/modular/style/headband
	name = "TGMC头巾"
	desc = "一条头巾.能挡住流进眼睛的汗水,还能让你看起来很酷."
...
/obj/item/clothing/head/modular/style/bandana
	name = "TGMC方巾"
	desc = "一条戴在头上的方巾.后系带上有TGMC标记,而且不知怎么的,这个结似乎永远不会松开."
...
/obj/item/clothing/mask/gas/modular/skimask
	name = "滑雪面罩"
	desc = "一个时尚的滑雪面罩,可以重新染色.光是看着它就能让你感觉自己像个特工."
...
/obj/item/clothing/mask/gas/modular/coofmask
	name = "战斗面罩"
	desc = "CFCC是一款精良、随时可用且时尚的面罩,准备好...遮住你的脸."
