...
/obj/item/armor_module/module/pt_belt
	...
	desc = "军士长命令陆战队员佩戴反光腰带以确保陆战队员的安全。你可以推测体能训练腰带能带来什么危险。"
...
/obj/item/armor_module/module/better_shoulder_lamp
	name = "\improper 巴德尔光放大系统"
	desc = "设计用于安装在模块化护甲上. 大幅提升模块化护甲所安装手电筒的功率输出. 成为黑暗中的光芒."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
	icon_state = "mod_lamp"
...
/obj/item/armor_module/module/valkyrie_autodoc
	...
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
	desc = "设计用于安装在模块化护甲上. 该模块拥有先进的医疗系统, 可根据使用者的需求注射三可定和曲马多, 并自动固定穿戴者的骨骼和身体, 在专业医疗救治之前有效起到夹板作用. 必定会影响机动性."
...
/obj/item/armor_module/module/valkyrie_autodoc/som
	...
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
	desc = "设计用于安装在SOM战斗护甲上, 或安装在戈尔贡突击护甲内部. 该模块拥有先进的医疗系统, 可根据使用者的需求注射三可定和曲马多, 并自动固定穿戴者的骨骼和身体, 在专业医疗救治之前有效起到夹板作用. 必定会影响机动性."
...
/obj/item/armor_module/module/fire_proof
	...
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
	desc = "设计用于安装在模块化护甲上. 它能保护你免受火焰影响, 并防止你以任何方式被点燃. 将此与对应的头盔模块搭配穿戴将使你完全免疫火焰. 必定会影响机动性."
	icon_state = "mod_fire"
...
/obj/item/armor_module/module/fire_proof_helmet
	...
	desc = "设计用于安装在模块化头盔上. 它能保护你免受火焰影响, 并防止你以任何方式被点燃. 将此与对应的护甲模块搭配穿戴将使你完全免疫火焰. 必定会影响机动性."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/fire_proof/som
	...
	desc = "设计用于安装在SOM模块化护甲上. 它提供对火焰效果的近乎免疫, 并防止你以任何方式被点燃. 将此与对应的头盔模块搭配穿戴将使你完全免疫火焰. 实际上不会提供任何对沃尔凯特武器的抗性. 会影响机动性."
...
/obj/item/armor_module/module/tyr_extra_armor
	name = "\improper 提尔Mk.2护甲强化系统"
	desc = "设计用于安装在模块化护甲上. 大量额外装甲板, 旨在为用户提供额外防护以应对各种威胁, 从异形爪击到友军误伤事件. 此较新版本拥有更好的防护. 必定会影响机动性."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/tyr_extra_armor/mark1
	name = "\improper 提尔Mk.1护甲强化系统"
	desc = "设计用于安装在模块化护甲上. 相当数量的额外全方位装甲板, 旨在为用户提供额外防护以应对任何类型的威胁. 此较旧版本防护较差. 会严重影响机动性."
...
/obj/item/armor_module/module/tyr_extra_armor/som
	name = "\improper 洛里卡护甲强化系统"
	desc = "设计用于安装在SOM模块化护甲上. 大量额外装甲板, 旨在为用户提供额外防护以应对所有形式的伤害. 必定会影响机动性."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/tyr_head
	name = "\improper 提尔Mk.1护甲强化系统头盔模块"
	desc = "设计用于安装在模块化头盔上. 大量全方位装甲板, 旨在为用户提供额外防护以应对任何类型的威胁."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/tyr_head/mark2
	name = "\improper 提尔Mk.2护甲强化系统头盔模块"
	desc = "设计用于安装在模块化头盔上. 安装后, 该系统对大多数伤害性危害提供大量抗性, 从异形爪击到友军误伤事件."
	soft_armor = list(MELEE = 10, BULLET = 15, LASER = 15, ENERGY = 15, BOMB = 15, BIO = 0, FIRE = 10, ACID = 0)
...
/obj/item/armor_module/module/ballistic_armor
	...
	desc = "设计用于安装在模块化护甲上. 包含大量防弹装甲板, 以及能量反射和热耗散材料, 使其对子弹和激光均具有高等级防御. 会影响机动性."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
	icon_state = "mod_ff"
...
/obj/item/armor_module/module/hod_head
	...
	desc = "设计用于安装在模块化头盔上. 包含大量防弹装甲板, 以及能量反射和热耗散材料, 使其对子弹和激光均具有高等级防御. 会影响机动性."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/mimir_environment_protection
	name = "\improper 密米尔Mk.2环境抗性系统"
	desc = "设计用于安装在模块化护甲上. 此较新型号对酸液, 生物和辐射攻击提供极佳抗性. 将此与密米尔头盔模块和面罩搭配使用将使使用者免疫任何毒气云. 会影响机动性."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/mimir_environment_protection/mark1
	name = "\improper 密米尔Mk.1环境抗性系统"
	desc = "设计用于安装在模块化护甲上. 此较旧型号对酸液, 生物和辐射攻击提供轻微抗性. 将此与密米尔头盔模块和面罩搭配使用将使使用者几乎免疫任何毒气云. 会影响机动性."
	icon_state = "mod_biohazard"
	worn_icon_state = "mod_biohazard_a"
...
/obj/item/armor_module/module/mimir_environment_protection/som
	name = "\improper 米特里达提乌斯环境抗性系统"
	desc = "设计用于安装在SOM模块化护甲上. 该模块似乎旨在保护使用者免受辐射攻击的影响, 但也提供对酸液和毒气等其他环境威胁的改进抗性. 将此与米特里达提乌斯头盔模块和面罩搭配使用将使使用者免疫毒气云. 会影响机动性."
	icon_state = "mithridatius"
	worn_icon_state = "mithridatius_a"

/obj/item/armor_module/module/mimir_environment_protection/mimir_helmet
	name = "\improper 密米尔Mk.2环境抗性系统头盔模块"
	desc = "设计用于安装在模块化头盔上. 对异形毒气云提供良好抗性. 此较新型号对酸液, 生物甚至辐射攻击提供极佳抗性."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/mimir_environment_protection/mimir_helmet/mark1
	name = "\improper 密米尔Mk.1环境抗性系统头盔模块"
	desc = "设计用于安装在模块化头盔上. 此较旧型号对酸液和生物攻击提供轻微抗性."
	soft_armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 15, FIRE = 0, ACID = 15)
...
/obj/item/armor_module/module/hlin_explosive_armor
	name = "\improper 赫林爆炸缓冲系统"
	desc = "设计用于安装在模块化护甲上. 使用一套复杂的装甲板和缓冲来减轻爆炸效果. 会影响机动性"
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/ballistic_armor
	...
	desc = "设计用于安装在模块化护甲上. 大量额外反射性防弹装甲板, 旨在减少友军误伤事件的影响, 将减轻子弹和激光的效果. 会影响机动性."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
	icon_state = "mod_ff"
	worn_icon_state = "mod_ff_a"
	soft_armor = list(MELEE = 0, BULLET = 40, LASER = 40, ENERGY = 0, BOMB = 40, BIO = 0, FIRE = 0, ACID = 0)
...
/obj/item/armor_module/module/chemsystem
	...
	desc = "设计用于安装在模块化护甲上. 该实验性模块使用从异形身上通过采集者级武器取得的绿色血液运行; 绿色血液可治疗使用者并增强护甲注射系统中的任何化学物质. \nUse护甲菜单以连接采集者级武器, 控制注射系统, 查找化学增强信息等."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/eshield
	...
	desc = "护甲系统的一项全新创新, 该模块在使用者周围生成一个护盾, 能够抵消所有伤害, 代价是对近战, 生物和酸液攻击的脆弱性增加. 如果承受过多伤害, 它将停用, 并使用户处于脆弱状态直到重新充能."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/eshield/proc/parent_examine(datum/source, mob/user, list/examine_list)
	...
	if(!recharge_timer)
		return
	examine_list += span_warning("充能已延迟! 将在[timeleft(recharge_timer) * 0.1]秒后再次开始充能!")
...
/obj/item/armor_module/module/eshield/som
	...
	desc = "一个精密的护盾单元, 旨在分散来袭冲击的能量, 使其对使用者无害. 如果承受过多伤害, 它将停用, 并使用户处于脆弱状态. 尚不清楚这是纯SOM设计的模块, 还是从TGMC大约同时期开发的\"斯瓦林\"护盾系统逆向工程而来."

/obj/item/armor_module/module/mirage
	name = "\improper 洛基幻象投影系统"
	desc = "设计用于安装在模块化护甲上. 该模块在使用者位置生成全息投影, 同时使其在短时间内隐形, 可用于分散敌人注意力并吸引其火力."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/armorlock
	name = "\improper 托尔护甲锁定系统"
	desc = "设计用于安装在模块化护甲上. 该模块在激活时封闭护甲缝隙, 使使用者无法执行任何动作但提高其护甲."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/style
	name = "\improper 护甲均衡器"
	desc = "设计用于安装在常规衣物上, 使其获得一定程度的防护强化."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
	icon_state = "mod_armor"
...
/obj/item/armor_module/module/welding
	...
	desc = "设计用于安装在模块化头盔上. 该模块可开启或关闭, 作为保护你脆弱双眼的焊接防护."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/welding/activate(mob/living/user)
	...
	to_chat(user, span_notice("你\the [src]. [active ? "enabling" : "disabling"]它."))
...
/obj/item/armor_module/module/welding/som
	name = "集成焊接面罩头盔模块"
	desc = "SOM工程头盔的内置焊接模块. 该模块可开启或关闭, 作为保护你脆弱双眼的焊接防护."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/welding/superior
	...
	desc = "设计用于安装在模块化头盔上. 此更昂贵的模块可开启或关闭, 作为保护你脆弱双眼的焊接防护, 奇怪的是闻起来像土豆."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
	icon_state = "welding_head"
	worn_icon_state = "welding_head_a"
	slot = ATTACHMENT_SLOT_HEAD_MODULE
...
/obj/item/armor_module/module/binoculars
	name = "\improper HM-6双筒头盔模块"
	desc = "设计用于安装在模块化头盔上. 可翻下以观察远处."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/binoculars/activate(mob/living/user)
	if(!(user.client.eye == user) && !(user.client.eye == user.loc))
		to_chat(user, span_warning("你现在正通过其他东西观察."))
		return
	zoom(user)
...
/obj/item/armor_module/module/binoculars/artemis_mark_two // a little cheating with subtypes
	name = "\improper Freyr Mk.2 视觉辅助头盔系统"
	desc = "设计用于安装在模块化头盔上。Freyr 模块配备了一个叠加式护目镜,能够增强使用者的视觉,使其即使在最恶劣的环境下也能清晰视物。此版本经过强化,允许陆战队员透过护目镜进行观察,类似于双筒望远镜。"
...
/obj/item/armor_module/module/artemis
	name = "\improper Freyr Mk.1 视觉辅助头盔系统"
	desc = "设计用于安装在模块化头盔上。Freyr 模块配备了一个叠加式护目镜,能够增强使用者的视觉,使其即使在最恶劣的环境下也能清晰视物。"
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/antenna
	...
	desc = "设计用于安装在模块化头盔上。此模块能够提供使用者的坐标读数,并连接到舰载补给终端,同时屏蔽洞穴的干扰,允许在浅层洞穴中正常通讯,在深层洞穴中仅有轻微干扰。"
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
...
/obj/item/armor_module/module/motion_detector/activate(mob/living/user)
	active = !active
	to_chat(user, span_notice("你\the [src][active ? "enabling" : "disabling"]了它。"))
	if(active)
		operator = user
		if(!motion_timer)
...
/obj/item/armor_module/module/pluto
	name = "\improper Pluto 隐蔽模块"
	desc = "一种特殊系统,有助于向异形隐藏你的气味和体温,对它们隐藏你的状态。同时包含一个集成健康分析仪。"
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
