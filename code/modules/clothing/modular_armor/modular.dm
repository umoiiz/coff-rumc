...
/obj/item/clothing/suit/modular
	name = "Jaeger XM-02战斗外骨骼"
	desc = "设计用于安装各种模块化装甲组件和支援系统. 出厂预装轻型装甲板和肩灯. 用组件点击框架即可安装装甲部件. 使用Alt-Click移除任何已安装的物品."
...
/obj/item/clothing/suit/modular/mob_can_equip(mob/user, slot, warning = TRUE, override_nodrop = FALSE, bitslot = FALSE)
	if(slot == SLOT_WEAR_SUIT && ishuman(user))
		...
		if(!istype(undersuit, allowed_uniform_type))
			to_chat(user, span_warning("你必须穿着陆战队员连体服才能装备此物."))
			return FALSE
	return ..()
...
/obj/item/clothing/suit/modular/attack_self(mob/user)
	...
	if(.)
		return
	if(!isturf(user.loc))
		to_chat(user, span_warning("在[user.loc]中时无法打开灯光."))
		return
...
/obj/item/clothing/suit/modular/rownin
	name = "\improper Rownin骨架"
	desc = "一种轻型装甲, 如果这也能算装甲的话, 适合那些愿意用防护换取灵活性的陆战队员. Alt-Click移除已安装的物品. 使用它来切换内置手电筒."
...
/obj/item/clothing/suit/modular/rownin/erp
	name = "\improper ERP rownin骨架"
	desc = "Rownin骨架的改装版, 提供了更好, 更有趣, 更能整蛊的设计. 哦, 装甲也改进了, 不过那部分不重要. Alt-Click移除已安装的物品. 使用它来切换内置手电筒."
...
/obj/item/clothing/suit/modular/rownin/gta
	name = "\improper 街头rownin骨架"
	desc = "一种轻型模块化背带, 在追求机动性胜过装甲的帮派枪手中很受欢迎."
...
/obj/item/clothing/suit/modular/rownin/gta/medic
	name = "\improper 街头医疗兵rownin骨架"
	desc = "一种轻型模块化背带, 带有医疗袋挂架——给那些被困在包扎伤口的人用."
	starting_attachments = list(
		/obj/item/armor_module/module/better_shoulder_lamp,
		/obj/item/armor_module/storage/medical,
	)
...
/obj/item/clothing/suit/modular/rownin/gta/leader
	name = "\improper 街头大佬rownin骨架"
	desc = "一种轻型模块化背带, 带有通用袋——有空间放望远镜, 无线电, 和糟糕的决定."
	starting_attachments = list(
		/obj/item/armor_module/module/better_shoulder_lamp,
		/obj/item/armor_module/storage/general,
	)
...
/obj/item/clothing/suit/modular/hardsuit_exoskeleton
	name = "\improper FleckTex WY-01模块化外骨骼"
	desc = "FleckTex Dynamics全新的模块化硬质外骨骼, 设计为与jaeger模块完全兼容. 出厂预装轻型装甲板和肩灯. 用组件点击框架即可安装装甲部件. 使用Alt-Click移除任何已安装的物品."
...
/obj/item/clothing/suit/modular/vsd_exoskeleton
	name = "\improper CrashCore MT/P模块化外骨骼"
	desc = "CrashCore Industries的模块化硬质外骨骼, 为支撑'超重型'装甲系统而制造, 设计为与jaeger模块完全兼容. 出厂预装轻型装甲板和肩灯. 用组件点击框架即可安装装甲部件. 使用Alt-Click移除任何已安装的物品."
	icon_state = "exoskeleton"
	worn_icon_state = "exoskeleton"
...
/obj/item/clothing/mask/gas/modular
	name = "时尚面具"
	desc = "一个酷炫有型的面具, 通过某种神秘魔法能阻挡毒气攻击. 怎么做到的? 谁知道呢. 你到底是怎么弄到这玩意的?"
	breathy = FALSE
	icon_state = "gas_alt"
