/obj/item/clothing/mask/gas
	name = "透明防毒面具"
	desc = "一种覆盖面部的面罩,可连接到供气装置.可过滤空气中的有害气体."
	icon_state = "gas_alt"
...
/obj/item/clothing/mask/gas/tactical/coif
	name = "战术头巾式防毒面具"
	desc = "一种覆盖面部的头巾式面罩,可连接到供气装置.可过滤空气中的有害气体."
	icon_state = "gascoif"
	inv_hide_flags = HIDEEARS|HIDEFACE|HIDEALLHAIR

/obj/item/clothing/mask/gas/pmc
	name = "\improper M8型装甲巴拉克拉瓦头套"
	desc = "一种装甲巴拉克拉瓦头套,旨在隐藏操作员的身份,同时起到空气过滤的作用."
	icon_state = "pmc_mask"
...
/obj/item/clothing/mask/gas/pmc/leader
	name = "\improper M8型装甲巴拉克拉瓦头套"
	desc = "一种装甲巴拉克拉瓦头套,旨在隐藏操作员的身份,同时起到空气过滤的作用.这套装备看起来属于一名高级军官."
...
/obj/item/clothing/mask/gas/plaguedoctor
	name = "瘟疫医生面具"
	desc = "经典设计的现代化版本,这款面具不仅能过滤福龙,还能连接到供气装置."
...
/obj/item/clothing/mask/gas/specops
	name = "特种作战防毒面具"
	desc = "一种紧贴面部的战术面具,可连接到供气装置.基于旧式防毒面具设计."
...
/obj/item/clothing/mask/gas/space_ninja
	name = "忍者面具"
	desc = "一种紧贴面部的面具,既可作为空气过滤器,又是一种后现代时尚宣言."
	icon_state = "s-ninja"
...
/obj/item/clothing/mask/gas/separatist
	name = "TM-58标准防护防毒面具"
	desc = "原本是民用型号,正面用一块金属板加固.不太方便,但极其可靠.它曾被称为\"抵抗部队的脸面\"."
	icon_state = "separatist"
	inv_hide_flags = HIDEEARS|HIDEFACE|HIDEALLHAIR

/obj/item/clothing/mask/gas/veteran
	name = "老兵呼吸面罩"
	desc = "这款面罩的加固迷彩剪裁能很好地保护面部免受弹片和有害气体的伤害.漂亮的手工活,士兵!"
	icon_state = "veteran"
	inv_hide_flags = HIDEEARS|HIDEFACE|HIDEALLHAIR

/obj/item/clothing/mask/gas/fullgas
	name = "古代防毒面具"
	desc = "一种古老的全脸面罩,可连接供气装置.过滤空气中的有害气体."
	icon_state = "fullgas"
	inv_hide_flags = HIDEEARS|HIDEFACE|HIDEALLHAIR

/obj/item/clothing/mask/gas/sgmask
	name = "军用级防毒面具"
	desc = "一种军用级防毒面具,可连接供气装置.过滤空气中的有害气体."
	icon_state = "sgmask"

/obj/item/clothing/mask/gas/redmask
	name = "头巾式防毒面具"
	desc = "一种头巾式防毒面具,覆盖使用者头部的大部分,可连接供气装置.过滤空气中的有害气体."
	icon_state = "redmask"
	inv_hide_flags = HIDEEARS|HIDEFACE|HIDEALLHAIR
