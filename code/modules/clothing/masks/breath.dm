...
/obj/item/clothing/mask/breath/verb/toggle()
	...
	if(usr.canmove && !usr.stat && !usr.restrained())
		if(!src.hanging)
			...
			inventory_flags |= COVERMOUTH
			icon_state = "breath"
			to_chat(usr, "你将面罩拉上来遮住面部.")
		update_clothing_icon()

/obj/item/clothing/mask/breath/medical
	desc = "一个紧贴面部的无菌面罩,可连接到供气装置."
	name = "医用口罩"
	icon_state = "medical"
...
/obj/item/clothing/mask/rebreather
	name = "循环呼吸器"
	desc = "一种紧贴面部的装置,在你吸气时能瞬间加热或冷却空气,以免损伤肺部."
...
/obj/item/clothing/mask/rebreather/scarf
	name = "吸热头巾"
	desc = "一顶紧贴头部的帽子,覆盖头顶,后脑和两侧.也可调整以遮住面部下半部分,在恶劣环境中为使用者保暖."
	icon_state = "coif"
...
/obj/item/clothing/mask/bandanna
	name = "棕褐色头巾"
	desc = "一块有色,坚韧且隔热的布料,用来遮挡面部免受恶劣环境侵袭.这块是沙漠棕褐色"
	icon_state = "bandanna"
