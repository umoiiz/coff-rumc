...
/datum/surgery_step/cut_limb/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool, datum/limb/affected)
	user.visible_message(span_notice("[user]开始用\the [tool]切下[target]的[affected.display_name].") , \
	span_notice("你开始用\the [tool]切下[target]的[affected.display_name]."))
...
/datum/surgery_step/cut_limb/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool, datum/limb/affected)
	user.visible_message(span_notice("[user]用\the [tool]切下了[target]的[affected.display_name]."), \
	span_notice("你用\the [tool]切下了[target]的[affected.display_name]."))
...
/datum/surgery_step/generic/cut_limb/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool, datum/limb/affected)
	user.visible_message(span_warning("[user]的手滑了,用\the [tool]锯穿了[target]的[affected.display_name]中的骨头!"), \
	span_warning("你的手滑了,用\the [tool]锯穿了[target]的[affected.display_name]中的骨头!"))
