...
/datum/surgery_step/fix_vein/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool, datum/limb/affected)
	user.visible_message(span_notice("[user]开始用\the [tool]修补[target]的[affected.display_name]里受损的血管。") , \
	span_notice("你开始用\the [tool]修补[target]的[affected.display_name]里受损的血管。"))
...
/datum/surgery_step/fix_vein/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool, datum/limb/affected)
	user.visible_message(span_notice("[user]用\the [tool]修补好了[target]的[affected.display_name]里受损的血管。"), \
		span_notice("你用\the [tool]修补好了[target]的[affected.display_name]里受损的血管。"))
...
/datum/surgery_step/fix_vein/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool, datum/limb/affected)
	user.visible_message(span_warning("[user]的手滑了一下,把[tool]涂抹在了[target]的[affected.display_name]上的切口里!") , \
	span_warning("你的手滑了一下,把[tool]涂抹在了[target]的[affected.display_name]上的切口里!"))
